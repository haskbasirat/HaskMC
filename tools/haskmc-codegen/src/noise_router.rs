    ...
    fn emit_compiled_eval_fn(
        ...
        match self {
            Self::Constant { value } => {
                ...
                quote! {
                    #[inline(always)]
                    pub fn #fn_name<C: NoiseEvaluationContext>(pos: &haskmc_util::math::vector3::Vector3<i32>, ctx: &mut C) -> f64 {
                        let _ = (pos, ctx);
                        #val
                    }
                }
    ...
    fn into_token_stream_compiled(mut self, router_name: &str) -> (TokenStream, TokenStream) {
        ...
        let compiled_mod_ts = quote! {
            pub mod #mod_ident {
                ...
                #[inline(always)]
                pub fn sample_final_density<C: NoiseEvaluationContext>(pos: &haskmc_util::math::vector3::Vector3<i32>, ctx: &mut C) -> f64 {
                    #final_density_fn(pos, ctx)
                }
                #[inline(always)]
                pub fn sample_barrier_noise<C: NoiseEvaluationContext>(pos: &haskmc_util::math::vector3::Vector3<i32>, ctx: &mut C) -> f64 {
                    #barrier_noise_fn(pos, ctx)
                }
                #[inline(always)]
                pub fn sample_fluid_level_floodedness_noise<C: NoiseEvaluationContext>(pos: &haskmc_util::math::vector3::Vector3<i32>, ctx: &mut C) -> f64 {
                    #fluid_floodedness_fn(pos, ctx)
                }
                #[inline(always)]
                pub fn sample_fluid_level_spread_noise<C: NoiseEvaluationContext>(pos: &haskmc_util::math::vector3::Vector3<i32>, ctx: &mut C) -> f64 {
                    #fluid_spread_fn(pos, ctx)
                }
                #[inline(always)]
                pub fn sample_lava_noise<C: NoiseEvaluationContext>(pos: &haskmc_util::math::vector3::Vector3<i32>, ctx: &mut C) -> f64 {
                    #lava_noise_fn(pos, ctx)
                }
                #[inline(always)]
                pub fn sample_vein_toggle<C: NoiseEvaluationContext>(pos: &haskmc_util::math::vector3::Vector3<i32>, ctx: &mut C) -> f64 {
                    #vein_toggle_fn(pos, ctx)
                }
                #[inline(always)]
                pub fn sample_vein_ridged<C: NoiseEvaluationContext>(pos: &haskmc_util::math::vector3::Vector3<i32>, ctx: &mut C) -> f64 {
                    #vein_ridged_fn(pos, ctx)
                }
                #[inline(always)]
                pub fn sample_vein_gap<C: NoiseEvaluationContext>(pos: &haskmc_util::math::vector3::Vector3<i32>, ctx: &mut C) -> f64 {
                    #vein_gap_fn(pos, ctx)
                }
                #[inline(always)]
                pub fn sample_erosion<C: NoiseEvaluationContext>(pos: &haskmc_util::math::vector3::Vector3<i32>, ctx: &mut C) -> f64 {
                    #erosion_fn(pos, ctx)
                }
                #[inline(always)]
                pub fn sample_depth<C: NoiseEvaluationContext>(pos: &haskmc_util::math::vector3::Vector3<i32>, ctx: &mut C) -> f64 {
                    #depth_fn(pos, ctx)
                }
            }
        };
...
pub fn build() -> TokenStream {
    ...
    quote! {
        ...
        pub trait NoiseEvaluationContext {
            ...
            fn sample_shift_a(&mut self, noise_id: DoublePerlinNoiseParameters, pos: &haskmc_util::math::vector3::Vector3<i32>) -> f64;
            fn sample_shift_b(&mut self, noise_id: DoublePerlinNoiseParameters, pos: &haskmc_util::math::vector3::Vector3<i32>) -> f64;
            ...
            fn sample_interpolated_noise(&mut self, pos: &haskmc_util::math::vector3::Vector3<i32>) -> f64;
            fn sample_beardifier(&mut self, pos: &haskmc_util::math::vector3::Vector3<i32>) -> f64;
            fn sample_blend_alpha(&mut self, pos: &haskmc_util::math::vector3::Vector3<i32>) -> f64;
            fn sample_blend_offset(&mut self, pos: &haskmc_util::math::vector3::Vector3<i32>) -> f64;
            fn sample_blend_density(&mut self, input_val: f64, pos: &haskmc_util::math::vector3::Vector3<i32>) -> f64;
            fn sample_end_islands(&mut self, pos: &haskmc_util::math::vector3::Vector3<i32>) -> f64;
            fn sample_wrapper(&mut self, wrapper_index: usize, wrapper_type: WrapperType, pos: &haskmc_util::math::vector3::Vector3<i32>, eval_input: &dyn Fn(&haskmc_util::math::vector3::Vector3<i32>, &mut Self) -> f64) -> f64;
            fn sample_spline(&mut self, spline_index: usize, location_value: f64, pos: &haskmc_util::math::vector3::Vector3<i32>) -> f64;
            fn sample_find_top_surface(&mut self, density_fn: &dyn Fn(&haskmc_util::math::vector3::Vector3<i32>, &mut Self) -> f64, upper_bound_fn: &dyn Fn(&haskmc_util::math::vector3::Vector3<i32>, &mut Self) -> f64, lower_bound: i32, cell_height: i32, pos: &haskmc_util::math::vector3::Vector3<i32>) -> f64;
        }
