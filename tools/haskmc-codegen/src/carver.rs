...
pub fn build() -> TokenStream {
    ...
    quote! {
        use haskmc_util::math::float_provider::{FloatProvider, NormalFloatProvider, ConstantFloatProvider, UniformFloatProvider, TrapezoidFloatProvider, ClampedNormalFloatProvider};
        use haskmc_util::y_offset::{YOffset, Absolute, AboveBottom, BelowTop};
...
fn value_to_float_provider(v: &Value) -> TokenStream {
    if v.is_number() {
        ...
        // This is complex because we need to match the structure of FloatProvider in haskmc-util
