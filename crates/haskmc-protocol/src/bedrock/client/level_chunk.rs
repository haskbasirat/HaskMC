...
impl CLevelChunk<'_> {
    pub fn encode_chunk(
        ...
        // Optional sub-chunk request limit. HaskMC sends complete chunks.
...
mod tests {
    ...
    use haskmc_nbt::{Nbt, compound::NbtCompound, deserializer::NbtReadHelperBedrock};
