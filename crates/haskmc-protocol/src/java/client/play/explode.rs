use haskmc_data::{packet::clientbound::play::EXPLODE, sound_id_remap::remap_sound_id_for_version};
        ...
        if *version >= JavaMinecraftVersion::V_1_21_2 {
            ...
            if *version >= JavaMinecraftVersion::V_1_20_3 {
                ...
                let small_particle = particle_id_for_version(
                    VarInt(haskmc_data::particle::Particle::Explosion as i32),
                    *version,
                );
                ...
                if *version >= JavaMinecraftVersion::V_1_20_5 {
                    ...
                    let (sound_name, range) = match &self.sound {
                        IdOr::Id(id) => {
                            ...
                            let name = haskmc_data::sound::Sound::NAMES
