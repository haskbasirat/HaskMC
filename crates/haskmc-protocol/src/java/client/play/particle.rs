...
use haskmc_util::{math::vector3::Vector3, version::JavaMinecraftVersion};
...
#[must_use]
pub const fn particle_name_for_v1_7(particle: haskmc_data::particle::Particle) -> &'static str {
...
pub fn particle_id_from_1_7_name(name: &str) -> i32 {
    match name {
        "explode" => haskmc_data::particle::Particle::Poof as i32,
        "largeexplode" => haskmc_data::particle::Particle::Explosion as i32,
        "hugeexplosion" => haskmc_data::particle::Particle::ExplosionEmitter as i32,
        "fireworksSpark" => haskmc_data::particle::Particle::Firework as i32,
        "bubble" => haskmc_data::particle::Particle::Bubble as i32,
        "splash" => haskmc_data::particle::Particle::Splash as i32,
        "wake" => haskmc_data::particle::Particle::Fishing as i32,
        "suspended" | "depthsuspend" => haskmc_data::particle::Particle::Underwater as i32,
        "crit" => haskmc_data::particle::Particle::Crit as i32,
        "magicCrit" => haskmc_data::particle::Particle::EnchantedHit as i32,
        "smoke" => haskmc_data::particle::Particle::Smoke as i32,
        "largesmoke" => haskmc_data::particle::Particle::LargeSmoke as i32,
        "spell" | "instantSpell" => haskmc_data::particle::Particle::InstantEffect as i32,
        "mobSpell" => haskmc_data::particle::Particle::EntityEffect as i32,
        "mobSpellAmbient" => haskmc_data::particle::Particle::Effect as i32,
        "witchMagic" => haskmc_data::particle::Particle::Witch as i32,
        "dripWater" => haskmc_data::particle::Particle::DrippingWater as i32,
        "dripLava" => haskmc_data::particle::Particle::DrippingLava as i32,
        "angryVillager" => haskmc_data::particle::Particle::AngryVillager as i32,
        "happyVillager" => haskmc_data::particle::Particle::HappyVillager as i32,
        "townaura" => haskmc_data::particle::Particle::Mycelium as i32,
        "note" => haskmc_data::particle::Particle::Note as i32,
        "portal" => haskmc_data::particle::Particle::Portal as i32,
        "enchantmenttable" => haskmc_data::particle::Particle::Enchant as i32,
        "flame" => haskmc_data::particle::Particle::Flame as i32,
        "lava" => haskmc_data::particle::Particle::Lava as i32,
        "cloud" => haskmc_data::particle::Particle::Cloud as i32,
        "reddust" => haskmc_data::particle::Particle::Dust as i32,
        "snowballpoof" | "snowshovel" => haskmc_data::particle::Particle::ItemSnowball as i32,
        "slime" => haskmc_data::particle::Particle::ItemSlime as i32,
        "heart" => haskmc_data::particle::Particle::Heart as i32,
        "barrier" => haskmc_data::particle::Particle::BlockMarker as i32,
        "droplet" => haskmc_data::particle::Particle::Rain as i32,
        _ => haskmc_data::particle::Particle::from_name(name).map_or(0, |p| p as i32),
    }
}
...
impl ClientPacket for CParticle<'_> {
    fn write_packet_data(
        ...
        if *version <= JavaMinecraftVersion::V_1_7_6 {
            let name = haskmc_data::particle::Particle::from_id(self.particle_id.0 as u16)
