...
use haskmc_data::item_id_remap::remap_item_id_for_version;
use haskmc_data::item_stack::ItemStack;
use haskmc_data::packet::clientbound::play::RECIPE_BOOK_ADD;
use haskmc_data::recipes::{
...
use haskmc_data::slot_display_id_remap::remap_slot_display_id_for_version;
...
fn resolve_item_tag(tag: &str, version: JavaMinecraftVersion) -> Option<Vec<&'static Item>> {
    ...
    let item_names =
        haskmc_data::tag::get_registry_key_tags(version, haskmc_data::tag::RegistryKey::Item)
