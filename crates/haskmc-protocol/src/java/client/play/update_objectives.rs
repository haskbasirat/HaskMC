...
use haskmc_data::packet::clientbound::play::SET_OBJECTIVE;
use haskmc_macros::java_packet;
use haskmc_util::{text::TextComponent, version::JavaMinecraftVersion};
            ...
            write.write_option(&self.number_format, |p, v| {
                match v {
                    ...
                    NumberFormat::Styled(_style) => {
                        ...
                        let comp = haskmc_nbt::compound::NbtCompound::new();
                        // Write style properties if any
                        let bytes = haskmc_nbt::Nbt::from(comp).write_unnamed();
