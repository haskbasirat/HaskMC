...
impl MetadataSerializer for haskmc_util::text::TextComponent {
    fn write_metadata(
        &self,
        writer: &mut impl std::io::Write,
        version: &JavaMinecraftVersion,
...
impl MetadataSerializer for Option<haskmc_util::text::TextComponent> {
    fn write_metadata(
        &self,
        writer: &mut impl std::io::Write,
        version: &JavaMinecraftVersion,
...
impl MetadataSerializer for haskmc_util::math::position::BlockPos {
    fn write_metadata(
        &self,
        writer: &mut impl std::io::Write,
        version: &JavaMinecraftVersion,
...
impl MetadataSerializer for Option<haskmc_util::math::position::BlockPos> {
    fn write_metadata(
        &self,
        writer: &mut impl std::io::Write,
        version: &JavaMinecraftVersion,
...
mod tests {
    ...
    use haskmc_data::{meta_data_type::MetaDataType, particle::Particle};
    use haskmc_util::version::JavaMinecraftVersion;
    ...
    fn encoded_particle(version: JavaMinecraftVersion) -> (VarInt, Vec<u8>) {
        ...
        let metadata = Metadata::new(
            haskmc_data::tracked_data::area_effect_cloud::DATA_PARTICLE,
            ParticleMetadata {
        ...
        assert_eq!(
            bytes[0],
            haskmc_data::tracked_data::area_effect_cloud::DATA_PARTICLE.get(&version)
        );
