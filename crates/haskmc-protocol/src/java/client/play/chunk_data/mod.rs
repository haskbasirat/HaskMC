...
use haskmc_data::packet::clientbound::play::LEVEL_CHUNK_WITH_LIGHT;
...
mod tests {
    ...
    fn populated_chunk_data_all_versions() {
        ...
        chunk
            .section
            .set_block_absolute_y(0, 64, 0, haskmc_data::Block::STONE.default_state.id);
        chunk
            .section
            .set_block_absolute_y(1, 64, 1, haskmc_data::Block::DIRT.default_state.id);
        ...
        chunk.pending_block_entities.lock().unwrap().insert(
            haskmc_util::math::position::BlockPos(haskmc_util::math::vector3::Vector3::new(
                0, 64, 0,
            )),
            nbt,
        );
