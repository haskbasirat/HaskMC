...
use haskmc_util::encompassing_bits;
...
pub fn write_chunk_data(
    ...
    if version >= &JavaMinecraftVersion::V_1_14 {
        ...
        comp.put("WORLD_SURFACE", haskmc_nbt::tag::NbtTag::LongArray(ws_vec));
        comp.put(
            "MOTION_BLOCKING",
            haskmc_nbt::tag::NbtTag::LongArray(mb_vec),
        );
        comp.put(
            "MOTION_BLOCKING_NO_LEAVES",
            haskmc_nbt::tag::NbtTag::LongArray(mbnl_vec),
        );
    ...
    if version >= &JavaMinecraftVersion::V_1_9_3 {
        ...
        for (pos, nbt) in valid_entities {
            ...
            entity_nbt.put("x", haskmc_nbt::tag::NbtTag::Int(pos.0.x));
            entity_nbt.put("y", haskmc_nbt::tag::NbtTag::Int(pos.0.y));
            entity_nbt.put("z", haskmc_nbt::tag::NbtTag::Int(pos.0.z));
