...
use haskmc_data::block_entity_type_id_remap::remap_block_entity_type_id_for_version;
use haskmc_data::packet::clientbound::play::BLOCK_ENTITY_DATA;
use haskmc_macros::java_packet;
use haskmc_util::{math::position::BlockPos, version::JavaMinecraftVersion};
