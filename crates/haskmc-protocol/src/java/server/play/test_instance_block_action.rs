use haskmc_data::packet::serverbound::play::TEST_INSTANCE_BLOCK_ACTION;
...
pub struct TestInstanceBlockData<'a> {
    ...
    pub rotation: haskmc_data::block_rotation::Rotation,
...
impl<'a> TestInstanceBlockData<'a> {
    fn read(bytebuf: &mut &'a [u8]) -> Result<Self, ReadingError> {
        ...
        let rotation = match bytebuf.get_var_int()?.0 {
            0 => haskmc_data::block_rotation::Rotation::None,
            1 => haskmc_data::block_rotation::Rotation::Clockwise90,
            2 => haskmc_data::block_rotation::Rotation::Rotate180,
            3 => haskmc_data::block_rotation::Rotation::CounterClockwise90,
    ...
    fn write(
        ...
        let rot_val = match self.rotation {
            haskmc_data::block_rotation::Rotation::None => 0,
            haskmc_data::block_rotation::Rotation::Clockwise90 => 1,
            haskmc_data::block_rotation::Rotation::Rotate180 => 2,
            haskmc_data::block_rotation::Rotation::CounterClockwise90 => 3,
        };
