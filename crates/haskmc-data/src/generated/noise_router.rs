...
pub trait NoiseEvaluationContext {
    ...
    fn sample_shift_a(
        &mut self,
        noise_id: DoublePerlinNoiseParameters,
        pos: &haskmc_util::math::vector3::Vector3<i32>,
    ) -> f64;
    fn sample_shift_b(
        &mut self,
        noise_id: DoublePerlinNoiseParameters,
    ...
    fn sample_interpolated_noise(&mut self, pos: &haskmc_util::math::vector3::Vector3<i32>)
    -> f64;
    ...
    fn sample_wrapper(
        ...
        pos: &haskmc_util::math::vector3::Vector3<i32>,
        eval_input: &dyn Fn(&haskmc_util::math::vector3::Vector3<i32>, &mut Self) -> f64,
    ) -> f64;
    fn sample_spline(
        &mut self,
        spline_index: usize,
    ...
    fn sample_find_top_surface(
        &mut self,
        density_fn: &dyn Fn(&haskmc_util::math::vector3::Vector3<i32>, &mut Self) -> f64,
        upper_bound_fn: &dyn Fn(&haskmc_util::math::vector3::Vector3<i32>, &mut Self) -> f64,
        lower_bound: i32,
        cell_height: i32,
        pos: &haskmc_util::math::vector3::Vector3<i32>,
    ) -> f64;
