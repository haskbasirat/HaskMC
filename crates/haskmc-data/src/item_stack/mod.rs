...
impl ItemStack {
    ...
    pub fn set_lore(&mut self, lines: Vec<haskmc_util::text::TextComponent>) {
    ...
    pub fn add_lore(&mut self, line: haskmc_util::text::TextComponent) {
        let mut lines = self
    ...
    pub fn set_custom_name(&mut self, name: String) {
        ...
        let component = Some(
            CustomNameImpl {
                name: haskmc_util::text::TextComponent::text(name),
            }
            .to_dyn(),
        );
...
mod tests {
    ...
    fn custom_data_preserves_other_item_components() {
        ...
        stack.patch.push((
            ...
            Some(
                CustomNameImpl {
                    name: haskmc_util::text::TextComponent::text("Marked Item"),
                }
                .to_dyn(),
            ),
        ));
    ...
    fn lore_can_be_set_and_appended() {
        let mut stack = ItemStack::new(1, &Item::WOODEN_AXE);
        stack.set_lore(vec![haskmc_util::text::TextComponent::text("First line")]);
        stack.add_lore(haskmc_util::text::TextComponent::text("Second line"));
