...
impl Rotation {
    ...
    #[must_use]
    pub const fn to_axis(self) -> haskmc_util::math::vector3::Axis {
        match self {
            Self::None | Self::Rotate180 => haskmc_util::math::vector3::Axis::Z,
            Self::Clockwise90 | Self::CounterClockwise90 => haskmc_util::math::vector3::Axis::X,
        }
    }
