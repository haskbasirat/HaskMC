            ...
            if slot_index == SLOT_INDEX_OUTSIDE {
                ...
                if click_type == MouseClick::Right {
                    ...
                    if !cursor_stack.is_empty() {
                        ...
                        if let Some(bundle) = inner_slot_stack.get_data_component_mut::<haskmc_data::data_component_impl::BundleContentsImpl>()
                    ...
                    if !intercepted && !slot_stack.is_empty()
                        && let Some(bundle) = cursor_stack.get_data_component_mut::<haskmc_data::data_component_impl::BundleContentsImpl>() {
                            let mut inner_slot_stack = slot.get_stack();
