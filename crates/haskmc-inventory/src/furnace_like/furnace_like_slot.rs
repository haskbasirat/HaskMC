...
use haskmc_data::{fuels::is_fuel, item::Item, statistic::StatisticCategory};
use haskmc_world::{block::entities::ExperienceContainer, inventory::Inventory};
...
impl Slot for FurnaceLikeSlot {
    ...
    fn can_insert(&self, stack: &haskmc_data::item_stack::ItemStack) -> bool {
...
impl Slot for FurnaceOutputSlot {
    ...
    fn can_insert(&self, _stack: &haskmc_data::item_stack::ItemStack) -> bool {
