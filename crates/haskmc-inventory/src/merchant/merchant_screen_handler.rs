...
pub struct MerchantScreenHandler {
    ...
    pub offers: Vec<haskmc_protocol::java::client::play::MerchantOffer>,
...
impl MerchantScreenHandler {
    pub fn new(
        ...
        offers: Vec<haskmc_protocol::java::client::play::MerchantOffer>,
    ) -> Self {
    ...
    fn adjusted_cost_a(offer: &haskmc_protocol::java::client::play::MerchantOffer) -> ItemStack {
    ...
    fn satisfies(
        offer: &haskmc_protocol::java::client::play::MerchantOffer,
        input_a: &ItemStack,
        input_b: &ItemStack,
    ) -> bool {
...
impl ScreenHandler for MerchantScreenHandler {
    ...
    fn on_slot_click(
        ...
        slot_index: i32,
        button: i32,
        action_type: haskmc_protocol::java::server::play::SlotActionType,
...
mod tests {
    ...
    use haskmc_data::{data_component_impl::EquipmentSlot, item::Item};
    use haskmc_protocol::{
    ...
    fn single_cost_offer(
        ...
        output: &'static Item,
        max_uses: i32,
    ) -> haskmc_protocol::java::client::play::MerchantOffer {
        haskmc_protocol::java::client::play::MerchantOffer {
    ...
    fn bookshelf_offer() -> haskmc_protocol::java::client::play::MerchantOffer {
