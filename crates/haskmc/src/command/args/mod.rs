...
use haskmc_protocol::java::client::play::{ArgumentType, CommandSuggestion, SuggestionProviders};
...
use haskmc_data::advancement::Advancement;
...
pub enum Arg<'a> {
    ...
    Item(&'a str),
    ItemPredicate(&'a str),
    ResourceLocation(haskmc_util::identifier::Identifier),
    Block(&'a str),
    ...
    TeamColor(haskmc_util::text::color::NamedColor),
    HexColor(u32),
}
