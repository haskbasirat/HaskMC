...
use haskmc_data::{entity::EntityType, translation};
use haskmc_nbt::compound::NbtCompound;
use haskmc_protocol::java::client::play::{ArgumentType, SuggestionProviders};
...
mod test {
    ...
    fn player_only_error_points_to_selector_start() {
        ...
        let translate_key = match error.message.0.content.as_ref() {
            haskmc_util::text::TextContent::Translate { translate, .. } => translate.as_ref(),
            _ => "",
        };
