...
use haskmc_protocol::java::client::play::ArgumentType;
        ...
        match value {
            NotInBounds::LowerBound(val, min) => {
                let (key, min_text, val_text) = match val {
                    Number::F64(_) | Number::F32(_) => (
                        haskmc_data::translation::java::ARGUMENT_DOUBLE_LOW,
                        min.to_string(),
                        val.to_string(),
                    ),
                    Number::I32(_) => (
                        haskmc_data::translation::java::ARGUMENT_INTEGER_LOW,
                        min.to_string(),
                        val.to_string(),
                    ),
                    Number::I64(_) => (
                        haskmc_data::translation::java::ARGUMENT_LONG_LOW,
                        min.to_string(),
                        val.to_string(),
                    ),
                };
            ...
            NotInBounds::UpperBound(val, max) => {
                let (key, max_text, val_text) = match val {
                    Number::F64(_) | Number::F32(_) => (
                        haskmc_data::translation::java::ARGUMENT_DOUBLE_BIG,
                        max.to_string(),
                        val.to_string(),
                    ),
                    Number::I32(_) => (
                        haskmc_data::translation::java::ARGUMENT_INTEGER_BIG,
                        max.to_string(),
                        val.to_string(),
                    ),
                    Number::I64(_) => (
                        haskmc_data::translation::java::ARGUMENT_LONG_BIG,
                        max.to_string(),
                        val.to_string(),
                    ),
                };
...
impl GetClientSideArgParser for BoundedNumArgumentConsumer<f64> {
    ...
    fn get_client_side_suggestion_type_override(
        &self,
    ) -> Option<haskmc_protocol::java::client::play::SuggestionProviders> {
        None
    }
}
