    ...
    fn execute(
        ...
        for target in targets {
            ...
            if let Some(idx) = idx {
                ...
                sender.send_message(TextComponent::translate_cross(
                    haskmc_data::translation::java::COMMANDS_PARDON_SUCCESS,
                    haskmc_data::translation::bedrock::COMMANDS_UNBAN_SUCCESS,
        ...
        if successes > 0 {
            ...
            Err(CommandError::CommandFailed(TextComponent::translate_cross(
                haskmc_data::translation::java::COMMANDS_PARDON_FAILED,
                haskmc_data::translation::bedrock::COMMANDS_UNBAN_FAILED,
