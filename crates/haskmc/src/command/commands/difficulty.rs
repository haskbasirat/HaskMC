...
use haskmc_util::{Difficulty, PermissionLvl};
...
impl CommandExecutor for DifficultySetExecutor {
    fn execute(&self, context: &CommandContext) -> CommandExecutorResult {
        ...
        context.source.send_feedback(
            TextComponent::translate_cross(
                haskmc_data::translation::java::COMMANDS_DIFFICULTY_SUCCESS,
                haskmc_data::translation::bedrock::COMMANDS_DIFFICULTY_SUCCESS,
                [TextComponent::translate_cross(
                    difficulty.translation_key(),
                    difficulty.translation_key(),
                    [],
