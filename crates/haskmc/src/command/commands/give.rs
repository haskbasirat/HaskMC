    ...
    fn execute(
        ...
        let msg = if targets.len() == 1 {
            TextComponent::translate_cross(
                haskmc_data::translation::java::COMMANDS_GIVE_SUCCESS_SINGLE,
                haskmc_data::translation::bedrock::COMMANDS_GIVE_SUCCESS,
                [
            ...
            TextComponent::translate_cross(
                haskmc_data::translation::java::COMMANDS_GIVE_SUCCESS_MULTIPLE,
                haskmc_data::translation::bedrock::COMMANDS_GIVE_SUCCESS,
                [
                    TextComponent::text(item_count.to_string()),
                    TextComponent::text("[")
