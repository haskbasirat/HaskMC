...
use haskmc_util::math::experience;
...
impl Executor {
    ...
    fn get_success_message(
        ...
        let bedrock_key = match self.exp_type {
            ExpType::Points => haskmc_data::translation::bedrock::COMMANDS_XP_SUCCESS,
            ExpType::Levels => {
                if amount >= 0 {
                    haskmc_data::translation::bedrock::COMMANDS_XP_SUCCESS_LEVELS
                } else {
                    haskmc_data::translation::bedrock::COMMANDS_XP_SUCCESS_NEGATIVE_LEVELS
                }
            }
        };
