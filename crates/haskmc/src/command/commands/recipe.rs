...
use haskmc_protocol::codec::recipe::DynamicRecipe;
use haskmc_protocol::java::client::play::CRecipeBookAdd;
...
fn get_recipe_id(recipe: &DynamicRecipe) -> String {
    match recipe {
        DynamicRecipe::Crafting(crafting) => match crafting {
            haskmc_protocol::codec::recipe::OwnedCraftingRecipe::Shaped {
                recipe_id,
                result,
                ..
            }
            | haskmc_protocol::codec::recipe::OwnedCraftingRecipe::Shapeless {
                recipe_id,
                result,
                ..
        ...
        DynamicRecipe::Cooking(cooking) => match cooking {
            haskmc_protocol::codec::recipe::OwnedCookingRecipeType::Smelting(r)
            | haskmc_protocol::codec::recipe::OwnedCookingRecipeType::Blasting(r)
            | haskmc_protocol::codec::recipe::OwnedCookingRecipeType::Smoking(r)
            | haskmc_protocol::codec::recipe::OwnedCookingRecipeType::CampfireCooking(r) => {
                r.recipe_id.clone()
            }
        },
    }
