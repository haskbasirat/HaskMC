    ...
    fn execute(
        ...
        let Ok(ip) = IpAddr::from_str(target) else {
            return Err(CommandError::CommandFailed(TextComponent::translate_cross(
                haskmc_data::translation::java::COMMANDS_PARDONIP_INVALID,
                haskmc_data::translation::bedrock::COMMANDS_UNBANIP_INVALID,
                [],
            )));
        };
            ...
            .map_or_else(
                || {
                    Err(CommandError::CommandFailed(TextComponent::translate_cross(
                        haskmc_data::translation::java::COMMANDS_PARDONIP_FAILED,
                        haskmc_data::translation::java::COMMANDS_PARDONIP_FAILED,
                        [],
                    )))
                },
                |idx| {
                    ...
                    sender.send_message(TextComponent::translate_cross(
                        haskmc_data::translation::java::COMMANDS_PARDONIP_SUCCESS,
                        haskmc_data::translation::bedrock::COMMANDS_UNBANIP_SUCCESS,
