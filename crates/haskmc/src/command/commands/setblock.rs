    ...
    fn execute(
        ...
        if success {
            sender.send_message(TextComponent::translate_cross(
                haskmc_data::translation::java::COMMANDS_SETBLOCK_SUCCESS,
                haskmc_data::translation::bedrock::COMMANDS_SETBLOCK_SUCCESS,
                [
            ...
            Err(CommandError::CommandFailed(TextComponent::translate_cross(
                haskmc_data::translation::java::COMMANDS_SETBLOCK_FAILED,
                haskmc_data::translation::bedrock::COMMANDS_SETBLOCK_FAILED,
                [],
            )))
        }
    }
