...
use haskmc_data::packet::{CURRENT_MC_VERSION, LOWEST_SUPPORTED_MC_VERSION};
use haskmc_protocol::{
...
const DEFAULT_ICON: &[u8] = include_bytes!("../../../../assets/haskmc-server-icon.png");
...
impl Default for CachedStatus {
    fn default() -> Self {
        Self::new(
            ...
            "A fast and efficient HaskMC server!",
            1000,
        )
    }
}
