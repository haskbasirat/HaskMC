...
use haskmc_protocol::java::client::play::{CSystemChatMessage, CTickingState, CTickingStep};
...
impl ServerTickRateManager {
    ...
    pub async fn update_joining_player(&self, player: &Player) {
        if player.client.java_version() >= haskmc_util::version::JavaMinecraftVersion::V_1_20_3 {
            player
