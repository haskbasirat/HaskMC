...
use haskmc_data::data_component_impl::DamageResistantImpl;
use haskmc_data::data_component_impl::DamageResistantType;
use haskmc_data::item_stack::ItemStack;
use haskmc_nbt::compound::NbtCompound;
use haskmc_protocol::bedrock::client::CAddItemActor;
use haskmc_protocol::bedrock::network_item::ItemStackWrapper;
...
use haskmc_util::math::atomic_f32::AtomicF32;
...
impl ItemEntity {
    ...
    pub fn new_empty(entity: Entity) -> Self {
        Self {
            entity,
            item_stack: Mutex::new(ItemStack::new(1, &haskmc_data::item::Item::AIR)),
            item_age: AtomicU32::new(0),
...
impl EntityBase for ItemEntity {
    ...
    fn init_data_tracker(&self) {
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::item::ITEM,
