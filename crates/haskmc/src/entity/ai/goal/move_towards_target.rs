...
use haskmc_util::math::{position::BlockPos, vector3::Vector3};
use rand::RngExt;
...
mod tests {
    ...
    fn initial_controls_and_state() {
        ...
        goal.wanted_pos = Some(haskmc_util::math::vector3::Vector3::new(1.0, 2.0, 3.0));
    ...
    impl crate::entity::mob::Mob for MockMob {
        ...
        fn mob_write_nbt(&self, _nbt: &mut haskmc_nbt::compound::NbtCompound) {
            unimplemented!()
        }
        fn mob_read_nbt(&self, _nbt: &haskmc_nbt::compound::NbtCompound) {
            unimplemented!()
        }
    }
}
