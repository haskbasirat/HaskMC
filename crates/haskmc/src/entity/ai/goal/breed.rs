    ...
    fn breed(mob: &dyn Mob, mate: &dyn EntityBase) {
        ...
        if let Some(player) = player_opt {
            ...
            player.increment_stat(
                ...
                haskmc_data::statistic::CustomStatistic::AnimalsBred as i32,
                1,
            );

            player.trigger_advancement_criterion(
                haskmc_data::advancement::Advancement::HUSBANDRY_BREED_AN_ANIMAL,
                "bred",
            );
            player.trigger_advancement_criterion(
                haskmc_data::advancement::Advancement::HUSBANDRY_BRED_ALL_ANIMALS,
