...
use haskmc_protocol::{codec::var_int::VarInt, java::client::play::Metadata};
...
impl CreeperEntity {
    ...
    pub fn set_fuse_speed(&self, speed: i32) {
        ...
        self.mob_entity.living_entity.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::creeper::FUSE_ID,
                VarInt(speed),
            )],
            None,
        );
...
impl Mob for CreeperEntity {
    ...
    fn mob_on_lightning_strike(
        ...
        self.mob_entity.living_entity.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::creeper::CHARGED,
                true,
            )],
            None,
        );
    ...
    fn mob_interact(&self, player: &Arc<Player>, item_stack: &mut ItemStack) -> bool {
        ...
        entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::creeper::IS_IGNITED,
                true,
            )],
            None,
        );
