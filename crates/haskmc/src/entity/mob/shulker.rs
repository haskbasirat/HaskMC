...
use haskmc_protocol::java::client::play::{CEntityPositionSync, Metadata};
...
impl ShulkerEntity {
    ...
    pub fn set_attach_face(&self, face: BlockDirection) {
        ...
        entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::shulker::ATTACH_FACE_ID,
                VarInt(face as i32),
            )],
            None,
        );
    ...
    pub fn set_color(&self, color: Option<u8>) {
        ...
        entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::shulker::COLOR,
                val as i8,
            )],
            None,
        );
    ...
    pub fn set_raw_peek(&self, amount: u8) {
        ...
        entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::shulker::PEEK_ID,
                amount,
            )],
            None,
        );
