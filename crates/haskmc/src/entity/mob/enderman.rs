...
use haskmc_data::{BlockStateId, attributes::Attributes};
...
fn is_projectile_damage(dt: DamageType) -> bool {
    let (names, _) = haskmc_data::tag::DamageType::MINECRAFT_IS_PROJECTILE;
...
impl EndermanEntity {
    ...
    pub fn set_angry(&self, angry: bool) {
        ...
        self.mob_entity.living_entity.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::enderman::CREEPY,
                angry,
            )],
            None,
        );
    ...
    pub fn set_provoked(&self, provoked: bool) {
        ...
        self.mob_entity.living_entity.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::enderman::STARED_AT,
                provoked,
            )],
            None,
        );
    ...
    pub fn set_carried_block(&self, block_state: Option<BlockStateId>) {
        ...
        self.mob_entity.living_entity.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::enderman::CARRY_STATE,
                value,
            )],
            None,
        );
