...
use haskmc_protocol::java::client::play::{CEntityStatus, Metadata};
...
impl CreakingEntity {
    ...
    pub fn set_can_move(&self, can_move: bool) {
        ...
        self.mob_entity.living_entity.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::creaking::CAN_MOVE,
                can_move,
            )],
            None,
        );
    ...
    pub fn set_is_active(&self, active: bool) {
        ...
        self.mob_entity.living_entity.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::creaking::IS_ACTIVE,
                active,
            )],
            None,
        );
    ...
    pub fn set_tearing_down(&self) {
        ...
        self.mob_entity.living_entity.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::creaking::IS_TEARING_DOWN,
                true,
            )],
            None,
        );
    ...
    pub fn set_home_pos(&self, pos: Option<BlockPos>) {
        ...
        self.mob_entity.living_entity.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::creaking::HOME_POS,
                pos,
            )],
            None,
        );
    ...
    pub fn check_can_move(&self) -> bool {
        ...
        for player in players {
            if player.living_entity.entity.is_alive()
                && player.gamemode.load() != haskmc_util::GameMode::Creative
                && player.gamemode.load() != haskmc_util::GameMode::Spectator
            {
