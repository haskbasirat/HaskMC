...
impl SlimeEntity {
    ...
    pub fn check_slime_spawn_rules(world: &World, pos: &BlockPos) -> bool {
        ...
        // if biome.has_tag(&haskmc_data::tag::WorldgenBiome::MINECRAFT_ALLOWS_SURFACE_SLIME_SPAWNS)
        //     && pos.0.y > 50
        //     && pos.0.y < 70
        // {
        ...
        let slime_seed = haskmc_util::random::seed_slime_chunk(
            chunk_pos.x,
            chunk_pos.y,
            world_seed,
            987_234_911,
        );
        let mut slime_rand = haskmc_util::random::legacy_rand::LegacyRand::from_seed(slime_seed);
    ...
    fn post_tick(&self) {
                ...
                .is_ok()
        {
            ...
            for i in 0..count {
                ...
                let new_pos = haskmc_util::math::vector3::Vector3::new(
                    pos.x + xd as f64,
                    pos.y + 0.5,
                    pos.z + zd as f64,
                );
