...
use haskmc_data::{entity::EntityType, item::Item};
...
impl Animal for ChickenEntity {
    fn is_food(&self, item_stack: &ItemStack) -> bool {
        ...
        item_stack
            .item
            .has_tag(&haskmc_data::tag::Item::MINECRAFT_CHICKEN_FOOD)
...
impl Mob for ChickenEntity {
    ...
    fn mob_init_data_tracker(&self) {
        ...
        if is_baby {
            entity.send_meta_data(
                &[haskmc_protocol::java::client::play::Metadata::new(
                    haskmc_data::tracked_data::chicken::BABY_ID,
                    true,
                )],
                None,
            );
        ...
        entity.send_meta_data(
            &[haskmc_protocol::java::client::play::Metadata::new(
                haskmc_data::tracked_data::chicken::VARIANT,
