...
pub trait Animal: Mob {
    ...
    fn write_animal_nbt(&self, nbt: &mut haskmc_nbt::compound::NbtCompound) {
        let mob_entity = self.get_mob_entity();
    ...
    fn read_animal_nbt(&self, nbt: &haskmc_nbt::compound::NbtCompound) {
        let mob_entity = self.get_mob_entity();
        ...
        if self.is_food(item_stack) {
            ...
            if age >= 0 && mob_entity.is_breeding_ready() && !mob_entity.is_in_love() {
                ...
                world.send_entity_status(
                    entity,
                    haskmc_data::entity::EntityStatus::InLoveHearts,
