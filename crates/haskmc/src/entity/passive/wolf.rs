    ...
    fn mob_init_data_tracker(&self) {
        ...
        if is_baby {
            entity.send_meta_data(
                &[Metadata::new(
                    haskmc_data::tracked_data::wolf::BABY_ID,
                    true,
                )],
                None,
            );
        ...
        entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::wolf::TAMEABLE_FLAGS,
                self.get_tame_flags(),
            )],
            None,
        );
        entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::wolf::COLLAR_COLOR,
        ...
        entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::wolf::WOLF_VARIANT_ID,
        ...
        entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::wolf::OWNER_UUID,
                self.get_owner(),
            )],
            None,
        );
