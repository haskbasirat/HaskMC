...
use haskmc_data::entity::{EntityStatus, EntityType};
...
use haskmc_protocol::java::client::play::Metadata;
use rand::RngExt;
use uuid::Uuid;
...
impl CatEntity {
    ...
    pub fn set_collar_color(&self, color: u8) {
        ...
        entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::cat::CAT_COLLAR_COLOR,
                VarInt(color as i32),
            )],
            None,
        );
    ...
    pub fn set_sitting(&self, sitting: bool) {
        ...
        entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::cat::TAMEABLE_FLAGS,
                self.get_tame_flags(),
            )],
            None,
        );
    ...
    pub fn set_tame(&self, tame: bool, owner: Option<Uuid>) {
        ...
        entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::cat::OWNER_UUID,
                owner,
            )],
            None,
        );
    ...
    pub fn set_variant(&self, variant: u8) {
        ...
        entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::cat::CAT_VARIANT,
    ...
    pub fn set_lying(&self, lying: bool) {
        ...
        entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::cat::IS_LYING,
                lying,
            )],
            None,
        );
    ...
    pub fn set_relax_state_one(&self, relax: bool) {
        ...
        entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::cat::RELAX_STATE_ONE,
                relax,
            )],
            None,
        );
    ...
    pub fn play_eating_sound(&self) {
        ...
        world.play_sound(
            haskmc_data::sound::Sound::EntityCatEat,
...
impl Mob for CatEntity {
    ...
    fn mob_init_data_tracker(&self) {
        ...
        if is_baby {
            entity.send_meta_data(
                &[Metadata::new(haskmc_data::tracked_data::cat::BABY_ID, true)],
                None,
            );
        }
        entity.send_meta_data(
        ...
        entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::cat::SOUND_VARIANT,
