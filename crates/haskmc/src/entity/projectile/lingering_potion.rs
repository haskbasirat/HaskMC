...
use haskmc_protocol::bedrock::server::actor_event::ActorEventID;
use haskmc_protocol::java::client::play::CWorldEvent;
use haskmc_util::math::position::BlockPos;
use haskmc_util::math::vector2::{Vector2, to_chunk_pos};
    ...
    pub fn new(entity: Entity) -> Self {
        ...
        Self {
            ...
            item_stack: RwLock::new(ItemStack::new(
                1,
                &haskmc_data::item::Item::LINGERING_POTION,
            )),
        }
    }
    ...
    fn init_data_tracker(&self) {
        ...
        entity.send_meta_data(
            &[haskmc_protocol::java::client::play::Metadata::new(
                haskmc_data::tracked_data::lingering_potion::ITEM_STACK,
