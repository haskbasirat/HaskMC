...
impl EntityBase for EyeOfEnder {
    ...
    fn init_data_tracker(&self) {
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::eye_of_ender::ITEM_STACK,
    ...
    fn send_java_spawn_packet(&self, client: &crate::net::java::JavaClient) {
        ...
        if client.version.load() >= haskmc_util::version::JavaMinecraftVersion::V_1_21 {
            ...
            if metadata.write(&mut data, &client.version.load()).is_ok() {
                data.push(255);
                let meta_packet = haskmc_protocol::java::client::play::CSetEntityMetadata::new(
