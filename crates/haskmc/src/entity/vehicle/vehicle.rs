...
impl VehicleEntity {
    ...
    pub async fn move_vehicle(
        &self,
        from: haskmc_util::math::vector3::Vector3<f64>,
        to: haskmc_util::math::vector3::Vector3<f64>,
    ) {
        let mut move_event =
    ...
    pub async fn collide_block(&self, block_pos: haskmc_util::math::position::BlockPos) {
        let mut base_event =
            crate::plugin::api::events::vehicle::vehicle_collision::VehicleCollisionEvent::new(
                self.entity.entity_id,
            );
    ...
    pub fn send_wobble_metadata(&self) {
        self.entity.send_meta_data(
            &[
                Metadata::new(
                    haskmc_data::tracked_data::boat::ID_HURT,
                    VarInt(self.get_hurt_time()),
                ),
                Metadata::new(
                    haskmc_data::tracked_data::boat::ID_HURTDIR,
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::boat::ID_DAMAGE,
                self.get_damage(),
            )],
            None,
        );
...
mod tests {
    ...
    fn wobble_integer_metadata(version: JavaMinecraftVersion) -> Vec<u8> {
        ...
        for metadata in [
            Metadata::new(haskmc_data::tracked_data::boat::ID_HURT, VarInt(10)),
            Metadata::new(haskmc_data::tracked_data::boat::ID_HURTDIR, VarInt(-1)),
        ] {
