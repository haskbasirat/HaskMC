...
use haskmc_data::{damage::DamageType, item_stack::ItemStack};
...
use haskmc_util::{math::vector3::Vector3, text::TextComponent};
...
impl DisplayEntity {
    ...
    pub fn set_interpolation_start_delta_ticks(&self, ticks: i32) {
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::display::START_INTERPOLATION,
                VarInt(ticks),
            )],
            None,
        );
    ...
    pub fn set_interpolation_duration(&self, duration: i32) {
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::display::INTERPOLATION_DURATION,
                VarInt(duration),
            )],
            None,
        );
    ...
    pub fn set_teleport_duration(&self, duration: i32) {
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::display::TELEPORT_DURATION,
                VarInt(duration),
            )],
            None,
        );
    ...
    pub fn set_translation(&self, translation: Vector3<f32>) {
        *self
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::display::TRANSLATION,
    ...
    pub fn set_scale(&self, scale: Vector3<f32>) {
        *self
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::display::SCALE,
    ...
    pub fn set_left_rotation(&self, left_rotation: [f32; 4]) {
        *self
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::display::LEFT_ROTATION,
    ...
    pub fn set_right_rotation(&self, right_rotation: [f32; 4]) {
        *self
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::display::RIGHT_ROTATION,
                QuaternionfSerializer(
                    right_rotation[0],
                    right_rotation[1],
                    right_rotation[2],
    ...
    pub fn set_billboard(&self, billboard: u8) {
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::display::BILLBOARD,
                billboard,
            )],
            None,
        );
    ...
    pub fn set_brightness(&self, brightness: i32) {
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::display::BRIGHTNESS,
                VarInt(brightness),
            )],
            None,
        );
    ...
    pub fn set_view_range(&self, view_range: f32) {
        *self
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::display::VIEW_RANGE,
                view_range,
            )],
            None,
        );
    ...
    pub fn set_shadow_radius(&self, shadow_radius: f32) {
        *self
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::display::SHADOW_RADIUS,
                shadow_radius,
            )],
            None,
        );
    ...
    pub fn set_shadow_strength(&self, shadow_strength: f32) {
        *self
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::display::SHADOW_STRENGTH,
                shadow_strength,
            )],
            None,
        );
    ...
    pub fn set_display_width(&self, width: f32) {
        *self
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::display::WIDTH,
                width,
            )],
            None,
        );
    ...
    pub fn set_display_height(&self, height: f32) {
        *self
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::display::HEIGHT,
                height,
            )],
            None,
        );
    ...
    pub fn set_glow_color_override(&self, color: i32) {
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::display::GLOW_COLOR_OVERRIDE,
                VarInt(color),
            )],
            None,
        );
...
impl BlockDisplayEntity {
    ...
    pub fn set_block_state(&self, block_state: i32) {
        ...
        self.display.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::block_display::BLOCK_STATE,
                VarInt(block_state),
            )],
            None,
        );
...
impl ItemDisplayEntity {
    pub fn new(entity: Entity) -> Arc<Self> {
        Arc::new(Self {
            display: DisplayEntity::new(entity),
            item_stack: Mutex::new(ItemStack::new(0, &haskmc_data::item::Item::AIR)),
    ...
    pub fn set_item(&self, item: ItemStack) {
        *self
        ...
        self.display.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::item_display::ITEM,
    ...
    pub fn set_item_display_mode(&self, mode: u8) {
        ...
        self.display.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::item_display::ITEM_DISPLAY,
                mode,
            )],
            None,
        );
...
impl TextDisplayEntity {
    ...
    pub fn set_text(&self, text: TextComponent) {
        *self
        ...
        self.display.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::text_display::TEXT,
                text,
            )],
            None,
        );
    ...
    pub fn set_line_width(&self, width: i32) {
        ...
        self.display.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::text_display::LINE_WIDTH,
                VarInt(width),
            )],
            None,
        );
    ...
    pub fn set_background_color(&self, color: i32) {
        ...
        self.display.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::text_display::BACKGROUND,
                VarInt(color),
            )],
            None,
        );
    ...
    pub fn set_text_opacity(&self, opacity: i8) {
        ...
        self.display.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::text_display::TEXT_OPACITY,
                opacity as u8,
            )],
            None,
        );
    ...
    pub fn set_shadow(&self, shadow: bool) {
        ...
        self.display.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::text_display::TEXT_DISPLAY_FLAGS,
                flags,
            )],
            None,
        );
...
impl EntityBase for TextDisplayEntity {
    fn write_custom_nbt(&self, nbt: &mut NbtCompound) {
        self.display.write_display_nbt(nbt);
        let text_json_res = haskmc_util::serde_json::to_string(
            &*self
                .text
                .lock()
                .unwrap_or_else(std::sync::PoisonError::into_inner),
    ...
    fn read_custom_nbt(&self, nbt: &NbtCompound) {
        ...
        if let Some(text_json) = nbt.get_string("text")
            && let Ok(component) = haskmc_util::serde_json::from_str(text_json)
        {
            *self
                .text
                .lock()
