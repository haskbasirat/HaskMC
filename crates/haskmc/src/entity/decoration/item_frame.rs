...
impl ItemFrameEntity {
    ...
    pub fn set_item(&self, mut item_stack: ItemStack, update_neighbours: bool) {
        ...
        *self
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::item_frame::ITEM,
                &item_serializer,
            )],
            None,
        );
    ...
    pub fn set_rotation(&self, rotation: u8, update_neighbours: bool) {
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                haskmc_data::tracked_data::item_frame::ROTATION,
                rot as i32,
            )],
            None,
        );
...
impl EntityBase for ItemFrameEntity {
    ...
    fn send_java_spawn_packet(&self, client: &crate::net::java::JavaClient) {
        ...
        if ver >= JavaMinecraftVersion::V_1_21 {
            ...
            let meta_item =
                Metadata::new(haskmc_data::tracked_data::item_frame::ITEM, item_serializer);
            let meta_rot = Metadata::new(haskmc_data::tracked_data::item_frame::ROTATION, rotation);
