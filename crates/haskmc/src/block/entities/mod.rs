...
use haskmc_data::{Block, block_properties::BLOCK_ENTITY_TYPES};
...
pub use haskmc_world::block::entities::PropertyDelegate;
...
pub fn create_block_entity(
    ...
    use haskmc_data::block_properties::FacingHopper;
    ...
    match *name {
        ...
        "piston" => Some(Arc::new(piston::PistonBlockEntity::from_nbt(
            &haskmc_nbt::compound::NbtCompound::new(),
            position,
        ))),
...
mod test {
    ...
    use haskmc_data::{item::Item, item_stack::ItemStack};
    use haskmc_nbt::compound::NbtCompound;
    use haskmc_util::math::position::BlockPos;
    use haskmc_world::inventory::Inventory;
    use std::sync::Arc;
