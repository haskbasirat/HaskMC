use haskmc_data::{Block, BlockId, BlockState};

use haskmc_data::BlockStateId;
use haskmc_util::math::position::BlockPos;
use haskmc_util::random::{RandomGenerator, get_seed, xoroshiro128::Xoroshiro};
...
pub fn calculate_comparator_output(inventory: &dyn haskmc_world::inventory::Inventory) -> u8 {
