...
use haskmc_data::block_properties::EastWall;
use haskmc_data::block_properties::HorizontalFacing;
use haskmc_data::block_properties::NorthWall;
use haskmc_data::block_properties::SouthWall;
use haskmc_data::block_properties::WestWall;
...
type FenceGateProperties = haskmc_data::block_properties::OakFenceGateLikeProperties;
type FenceLikeProperties = haskmc_data::block_properties::OakFenceLikeProperties;
type WallProperties = haskmc_data::block_properties::ResinBrickWallLikeProperties;

#[haskmc_block_from_tag("minecraft:walls")]
