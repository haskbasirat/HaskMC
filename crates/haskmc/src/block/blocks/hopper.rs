...
use haskmc_data::block_properties::{BlockProperties, FacingHopper};
use haskmc_data::{Block, BlockDirection, translation};
use haskmc_inventory::generic_container_screen_handler::create_hopper;
...
#[haskmc_block("minecraft:hopper")]
pub struct HopperBlock;

type HopperLikeProperties = haskmc_data::block_properties::HopperLikeProperties;
    ...
    fn normal_use(&self, args: NormalUseArgs<'_>) -> BlockActionResult {
            ...
            && let Some(inventory) = block_entity.get_inventory()
        {
            args.player.increment_stat(
                ...
                haskmc_data::statistic::CustomStatistic::InspectHopper as i32,
                1,
            );
            args.player
