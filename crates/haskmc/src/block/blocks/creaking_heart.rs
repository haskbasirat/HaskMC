...
#[haskmc_block("minecraft:creaking_heart")]
...
impl BlockBehaviour for CreakingHeartBlock {
    fn on_place(&self, args: OnPlaceArgs<'_>) -> BlockStateId {
        ...
        props.axis = match args.direction {
            haskmc_data::BlockDirection::North | haskmc_data::BlockDirection::South => Axis::Z,
            haskmc_data::BlockDirection::East | haskmc_data::BlockDirection::West => Axis::X,
            haskmc_data::BlockDirection::Up | haskmc_data::BlockDirection::Down => Axis::Y,
        };
