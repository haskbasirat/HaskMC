...
use haskmc_data::block_properties::{BlockProperties, LadderLikeProperties};
...
use haskmc_world::block::viewer::ViewerCountTracker;
...
#[haskmc_block("minecraft:ender_chest")]
