use haskmc_data::block_properties::{BlockProperties, RespawnAnchorLikeProperties};
...
#[haskmc_block("minecraft:respawn_anchor")]
...
impl BlockBehaviour for RespawnAnchorBlock {
    ...
    fn normal_use(&self, args: NormalUseArgs<'_>) -> BlockActionResult {
        ...
        if props.charges == 0 {
            args.player
                .send_system_message(&haskmc_macros::translate_cross!(
