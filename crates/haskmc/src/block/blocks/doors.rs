...
use haskmc_data::block_properties::DoorHinge;
use haskmc_data::block_properties::DoubleBlockHalf;
...
type DoorProperties = haskmc_data::block_properties::OakDoorLikeProperties;
...
#[haskmc_block_from_tag("minecraft:doors")]
