...
use haskmc_data::block_properties::{BlockProperties, TurtleEggLikeProperties};
use haskmc_data::entity::{EntityPose, EntityType};
use haskmc_data::sound::{Sound, SoundCategory};
use haskmc_data::tag::Taggable;
use haskmc_data::{Block, BlockDirection, BlockStateId, tag};
...
#[haskmc_block("minecraft:turtle_egg")]
