...
use haskmc_data::{BlockDirection, tag};
...
#[haskmc_block_from_tag("minecraft:lanterns")]
pub struct LanternBlock;

impl BlockBehaviour for LanternBlock {
    fn on_place(&self, args: OnPlaceArgs<'_>) -> BlockStateId {
        let mut props = haskmc_data::block_properties::LanternLikeProperties::default(args.block);
...
fn can_place_at(world: &World, position: &BlockPos) -> bool {
        ...
        .has_tag(&tag::Block::C_FENCE_GATES)
    {
        let fence_gate_props =
            haskmc_data::block_properties::OakFenceGateLikeProperties::from_state_id(
