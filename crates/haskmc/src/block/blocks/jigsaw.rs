...
use haskmc_data::{BlockDirection, BlockStateId};
use haskmc_macros::haskmc_block;
use haskmc_util::{GameMode, PermissionLvl};

use haskmc_world::generation::structure::structures::jigsaw::JigsawJointType;

#[haskmc_block("minecraft:jigsaw")]
...
impl BlockBehaviour for JigsawBlock {
    ...
    fn mirror(
        ...
        if mirror == Mirror::None {
            return haskmc_data::BlockState::from_id(state_id);
        }
        ...
        haskmc_data::BlockState::from_id(props.to_state_id(block))
    }
