...
use haskmc_data::{Block, BlockStateId, translation};
use haskmc_inventory::enchanting::enchanting_screen_handler::EnchantingTableScreenHandler;
...
use haskmc_world::inventory::{Inventory, SimpleInventory};

#[haskmc_block("minecraft:enchanting_table")]
