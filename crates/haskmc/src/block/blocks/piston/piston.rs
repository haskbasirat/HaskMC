...
pub(crate) type PistonProps = haskmc_data::block_properties::StickyPistonLikeProperties;
...
impl PistonBlock {
    ...
    pub fn is_movable(
        ...
        match state.piston_behavior {
            haskmc_data::block_state::PistonBehavior::Destroy => return can_break,
            haskmc_data::block_state::PistonBehavior::Block => return false,
            haskmc_data::block_state::PistonBehavior::PushOnly => return dir == piston_dir,
            _ => {}
        }
