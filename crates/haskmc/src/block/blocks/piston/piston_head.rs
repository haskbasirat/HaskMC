...
use haskmc_data::{Block, FacingExt};
...
pub(crate) type PistonHeadProperties = haskmc_data::block_properties::PistonHeadLikeProperties;

#[haskmc_block("minecraft:piston_head")]
