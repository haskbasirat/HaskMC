...
use haskmc_data::{Block, FacingExt, HorizontalFacingExt};
use haskmc_data::{BlockDirection, BlockId};
use haskmc_util::math::position::BlockPos;
use haskmc_world::world::BlockAccessor;

type WallTorchProps = haskmc_data::block_properties::WallTorchLikeProperties;
