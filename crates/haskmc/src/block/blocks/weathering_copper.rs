...
use haskmc_data::{Block, BlockId, BlockState, BlockStateId, Mirror, Rotation};
...
pub fn change_over_time(world: &Arc<World>, position: &BlockPos, block: &Block) {
    ...
    if block.has_tag(&haskmc_data::tag::Block::MINECRAFT_DOORS) {
