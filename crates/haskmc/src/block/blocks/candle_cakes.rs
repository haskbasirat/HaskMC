...
use haskmc_data::{Block, BlockStateId, item::Item, item_stack::ItemStack};
use haskmc_macros::haskmc_block_from_tag;
use haskmc_util::{GameMode, math::position::BlockPos};
use haskmc_world::{
    tick::TickPriority,
...
#[haskmc_block_from_tag("minecraft:candle_cakes")]
