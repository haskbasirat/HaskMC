...
use haskmc_data::block_properties::SlabType;
...
type SlabProperties = haskmc_data::block_properties::ResinBrickSlabLikeProperties;

#[haskmc_block_from_tag("minecraft:slabs")]
