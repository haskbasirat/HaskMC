...
use haskmc_data::block_properties::{BlockProperties, BubbleColumnLikeProperties};
use haskmc_data::fluid::Fluid;
use haskmc_data::tag::{self, Taggable};
use haskmc_data::{Block, BlockId, BlockStateId};
...
mod tests {
    ...
    use haskmc_data::fluid::{Falling, FlowingWaterLikeFluidProperties, FluidProperties, Level};
