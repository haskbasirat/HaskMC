...
use haskmc_data::data_component_impl::JukeboxPlayableImpl;
use haskmc_data::entity::EntityType;
use haskmc_data::jukebox_song::JukeboxSong;
...
#[haskmc_block("minecraft:jukebox")]
...
impl BlockBehaviour for JukeboxBlock {
    ...
    fn use_with_item(&self, args: UseWithItemArgs<'_>) -> BlockActionResult {
        ...
        args.player.increment_stat(
            ...
            haskmc_data::statistic::CustomStatistic::PlayRecord as i32,
            1,
        );
