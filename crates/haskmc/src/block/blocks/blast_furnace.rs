...
impl ScreenHandlerFactory for BlastingFurnaceScreenFactory {
    ...
    fn get_display_name(&self) -> haskmc_util::text::TextComponent {
...
#[haskmc_block("minecraft:blast_furnace")]
    ...
    fn normal_use(&self, args: NormalUseArgs<'_>) -> BlockActionResult {
            ...
            && let Some(experience_container) = block_entity.to_experience_container()
        {
            args.player.increment_stat(
                ...
                haskmc_data::statistic::CustomStatistic::InteractWithBlastFurnace as i32,
                1,
            );
