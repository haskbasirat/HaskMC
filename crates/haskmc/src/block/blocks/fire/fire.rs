...
use haskmc_data::block_properties::{BlockProperties, HorizontalAxis};
...
type FireProperties = haskmc_data::block_properties::FireLikeProperties;

use super::FireBlockBase;

#[haskmc_block("minecraft:fire")]
