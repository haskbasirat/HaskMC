...
use haskmc_data::chest_loot_table::get_chest_loot_table;
use haskmc_data::entity::EntityPose;
use haskmc_data::{Block, BlockDirection, translation};
use haskmc_inventory::double::DoubleInventory;
use haskmc_inventory::generic_container_screen_handler::{create_generic_9x3, create_generic_9x6};
use haskmc_inventory::player::player_inventory::PlayerInventory;
use haskmc_inventory::screen_handler::{
    InventoryPlayer, ScreenHandlerFactory, SharedScreenHandler,
};
use haskmc_macros::{haskmc_block, haskmc_block_from_tag};
...
fn player_placed_chest_impl(args: &PlayerPlacedArgs<'_>) {
    let position = haskmc_util::math::vector3::Vector3::new(
    ...
    args.world.play_bedrock_level_sound(
        "place",
        &position,
        i32::from(haskmc_data::BlockState::to_be_network_id(args.state_id)),
    );
}
...
fn normal_use_chest_impl(args: &NormalUseArgs<'_>) -> BlockActionResult {
    args.player.increment_stat(
        ...
        haskmc_data::statistic::CustomStatistic::OpenChest as i32,
        1,
    );
    let state = args.world.get_block_state_id(args.position);
    let first_chest = args.world.get_block_entity(args.position);
...
#[haskmc_block_from_tag("c:chests/wooden")]
...
#[haskmc_block_from_tag("minecraft:copper_chests")]
...
#[haskmc_block("minecraft:trapped_chest")]
