...
use haskmc_data::block_properties::Half;
use haskmc_data::block_properties::HorizontalFacing;
use haskmc_data::block_properties::StairsShape;
use haskmc_data::tag::Taggable;
use haskmc_data::{Block, BlockDirection, BlockState, BlockStateId, Mirror, Rotation, tag};
...
type StairsProperties = haskmc_data::block_properties::OakStairsLikeProperties;

#[haskmc_block_from_tag("minecraft:stairs")]
