...
use haskmc_data::block_properties::BedPart;
...
#[haskmc_block_from_tag("minecraft:beds")]
pub struct BedBlock;
...
impl BedBlock {
    ...
    fn use_bed(
        ...
        if player.set_respawn_point(
            ...
            player.send_system_message(&haskmc_macros::translate_cross!(
        ...
        player.increment_stat(
            ...
            haskmc_data::statistic::CustomStatistic::SleepInBed as i32,
            1,
        );
