...
use haskmc_data::block_properties::{AttachFace, BellAttachment, BellLikeProperties};
...
use haskmc_data::{HorizontalFacingExt, tag};
...
impl BlockBehaviour for BellBlock {
    ...
    fn normal_use(&self, args: NormalUseArgs<'_>) -> BlockActionResult {
        ...
        args.player.increment_stat(
            ...
            haskmc_data::statistic::CustomStatistic::BellRing as i32,
            1,
        );
