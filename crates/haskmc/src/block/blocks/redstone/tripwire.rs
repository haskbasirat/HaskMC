...
type TripwireProperties = haskmc_data::block_properties::TripwireLikeProperties;
type TripwireHookProperties = haskmc_data::block_properties::TripwireHookLikeProperties;

#[haskmc_block("minecraft:tripwire")]
