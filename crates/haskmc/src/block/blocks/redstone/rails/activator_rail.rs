...
#[haskmc_block("minecraft:activator_rail")]
...
impl ActivatorRailBlock {
    fn is_powered_by_other_rails(
        ...
        match next_shape {
            haskmc_data::block_properties::RailShape::NorthSouth => {
                if direction {
                    z += 1;
                } else {
                    z -= 1;
            ...
            haskmc_data::block_properties::RailShape::EastWest => {
                if direction {
                    x -= 1;
                } else {
                    x += 1;
            ...
            haskmc_data::block_properties::RailShape::AscendingEast => {
                if direction {
                    x -= 1;
                } else {
                    x += 1;
                ...
                next_shape = haskmc_data::block_properties::RailShape::EastWest;
            }
            haskmc_data::block_properties::RailShape::AscendingWest => {
                if direction {
                    x -= 1;
                    y += 1;
                    check_down = false;
            ...
            haskmc_data::block_properties::RailShape::AscendingNorth => {
                if direction {
                    z += 1;
                } else {
                    z -= 1;
                ...
                next_shape = haskmc_data::block_properties::RailShape::NorthSouth;
            }
            haskmc_data::block_properties::RailShape::AscendingSouth => {
                if direction {
                    z += 1;
                    y += 1;
                    check_down = false;
    ...
    fn is_powered_at_position(
        ...
        direction: bool,
        distance: u8,
        expected_shape: haskmc_data::block_properties::RailShape,
    ) -> bool {
    ...
    fn update_rail_at_position(
        ...
        let shapes_compatible = match expected_shape {
            haskmc_data::block_properties::RailShape::EastWest => !matches!(
                rail_shape,
                haskmc_data::block_properties::RailShape::NorthSouth
                    | haskmc_data::block_properties::RailShape::AscendingNorth
                    | haskmc_data::block_properties::RailShape::AscendingSouth
            ),
            haskmc_data::block_properties::RailShape::NorthSouth => !matches!(
                rail_shape,
                haskmc_data::block_properties::RailShape::EastWest
                    | haskmc_data::block_properties::RailShape::AscendingEast
                    | haskmc_data::block_properties::RailShape::AscendingWest
