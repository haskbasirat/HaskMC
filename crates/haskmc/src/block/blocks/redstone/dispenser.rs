...
use haskmc_data::block_properties::{BlockProperties, Facing};
use haskmc_data::entity::{EntityType, entity_from_egg};
...
use haskmc_data::{Block, BlockStateId, FacingExt};
use haskmc_inventory::generic_container_screen_handler::create_generic_3x3;
...
use haskmc_util::math::wrap_degrees;
...
#[haskmc_block("minecraft:dispenser")]
pub struct DispenserBlock;

type DispenserLikeProperties = haskmc_data::block_properties::DispenserLikeProperties;
