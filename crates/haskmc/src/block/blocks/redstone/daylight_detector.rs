...
use haskmc_data::{Block, block_properties::BlockProperties};
...
type DaylightDetectorProperties = haskmc_data::block_properties::DaylightDetectorLikeProperties;

#[haskmc_block("minecraft:daylight_detector")]
