...
type RWallTorchProps = haskmc_data::block_properties::FurnaceLikeProperties;
type RTorchProps = haskmc_data::block_properties::RedstoneOreLikeProperties;
