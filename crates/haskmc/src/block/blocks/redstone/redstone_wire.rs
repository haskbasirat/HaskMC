...
use haskmc_data::{Block, BlockDirection, BlockState, HorizontalFacingExt};
...
#[haskmc_block("minecraft:redstone_wire")]
...
fn is_trapdoor(block: &Block) -> bool {
    block.has_tag(&haskmc_data::tag::Block::MINECRAFT_TRAPDOORS)
}
