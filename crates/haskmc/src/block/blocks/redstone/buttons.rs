...
use haskmc_data::block_properties::AttachFace;
...
type ButtonLikeProperties = haskmc_data::block_properties::LeverLikeProperties;
...
#[haskmc_block_from_tag("minecraft:buttons")]
