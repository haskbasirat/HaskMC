...
use haskmc_data::scoreboard::ScoreboardDisplaySlot;
use haskmc_protocol::{
...
impl BedrockScoreboard {
    pub fn add_objective(&mut self, player: &Player, objective: BedrockObjective) {
        ...
        player.try_enqueue_packet_editioned(
            &haskmc_protocol::java::client::play::CUpdateObjectives::new(
                objective.name.clone(),
                haskmc_protocol::java::client::play::Mode::Add,
                TextComponent::text(objective.display_name.clone()),
                haskmc_protocol::java::client::play::RenderType::Integer,
                None,
            ),
            &be_update,
        );
    ...
    pub fn update_objective(&mut self, player: &Player, objective: BedrockObjective) {
        ...
        player.try_enqueue_packet_editioned(
            &haskmc_protocol::java::client::play::CUpdateObjectives::new(
                objective.name.clone(),
                haskmc_protocol::java::client::play::Mode::Update,
                TextComponent::text(objective.display_name.clone()),
                haskmc_protocol::java::client::play::RenderType::Integer,
                None,
            ),
    ...
    pub fn remove_objective(&mut self, player: &Player, name: &str) {
        ...
        player.try_enqueue_packet_editioned(
            &haskmc_protocol::java::client::play::CUpdateObjectives::new(
                name.to_string(),
                haskmc_protocol::java::client::play::Mode::Remove,
                TextComponent::text(""),
                haskmc_protocol::java::client::play::RenderType::Integer,
                None,
            ),
    ...
    pub fn set_display_objective(
        ...
        player.try_enqueue_packet_editioned(
            &haskmc_protocol::java::client::play::CDisplayObjective::new(
                match slot {
    ...
    pub fn update_score(
        ...
        player.try_enqueue_packet_editioned(
            &haskmc_protocol::java::client::play::CUpdateScore::new(
                score.entity_name.clone(),
                score.objective_name.clone(),
                score.value,
                score.display_name.clone(),
    ...
    pub fn remove_score(&mut self, player: &Player, entity_name: &str, objective_name: &str) {
        ...
        player.try_enqueue_packet_editioned(
            &haskmc_protocol::java::client::play::CResetScore::new(
                entity_name.to_string(),
    ...
    pub fn reset_scores_for_entity(&mut self, player: &Player, entity_name: &str) {
        ...
        player.try_enqueue_packet_editioned(
            &haskmc_protocol::java::client::play::CResetScore::new(entity_name.to_string(), None),
            &be_score,
        );
