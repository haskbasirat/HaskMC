...
pub struct ReadlineLogWrapper {
    readline: std::sync::Mutex<Option<Editor<HaskMcCommandCompleter, FileHistory>>>,
}
...
impl ReadlineLogWrapper {
    #[must_use]
    pub const fn new(rl: Option<Editor<HaskMcCommandCompleter, FileHistory>>) -> Self {
        Self {
            readline: std::sync::Mutex::new(rl),
        }
    }

    pub fn take_readline(&self) -> Option<Editor<HaskMcCommandCompleter, FileHistory>> {
        self.readline
            .lock()
    ...
    #[allow(dead_code)]
    pub fn return_readline(&self, rl: Editor<HaskMcCommandCompleter, FileHistory>) {
...
impl Helper for HaskMcCommandCompleter {}
impl Highlighter for HaskMcCommandCompleter {
...
impl Hinter for HaskMcCommandCompleter {
    type Hint = String;
...
impl Validator for HaskMcCommandCompleter {}

impl Completer for HaskMcCommandCompleter {
