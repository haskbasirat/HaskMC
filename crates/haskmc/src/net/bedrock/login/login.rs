...
impl BedrockClient {
    ...
    pub async fn try_handle_login(
        ...
        let player_data = if server.advanced_config.networking.bedrock.online_mode {
            ...
            haskmc_util::jwt::extract_oidc_token_player_claims(&auth_payload.token)?
        };
        ...
        let payload_bytes = haskmc_util::jwt::decode_b64_url_nopad(payload_b64)
        ...
        let login_public_key = haskmc_util::jwt::extract_cpk_from_token(&auth_payload.token)
