...
impl BedrockClient {
    pub fn handle_player_block_action(
        ...
        player: &Arc<Player>,
        server: &Server,
        packet: &haskmc_protocol::bedrock::server::player_auth_input::PlayerBlockAction,
    ) {
        use haskmc_protocol::bedrock::server::player_action::PlayerActionType as PlayerAction;
