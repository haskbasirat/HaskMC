        ...
        if version.supports_configuration_state() {
            ...
            if !sent_dimension_type {
                let dims = [
                    ...
                    &haskmc_data::dimension::Dimension::OVERWORLD_CAVES,
                    &haskmc_data::dimension::Dimension::THE_END,
                    &haskmc_data::dimension::Dimension::THE_NETHER,
                ];
                let dim_entries: Vec<haskmc_data::registry::RegistryEntryData> = dims
                    .iter()
                    .map(|dim| haskmc_data::registry::RegistryEntryData {
