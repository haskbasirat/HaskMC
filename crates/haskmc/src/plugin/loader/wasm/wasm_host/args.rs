...
pub enum OwnedArg {
    ...
    BlockPos(haskmc_util::math::position::BlockPos),
    Pos3D(haskmc_util::math::vector3::Vector3<f64>),
    Pos2D(haskmc_util::math::vector2::Vector2<f64>),
    Rotation(f32, bool, f32, bool),
    GameMode(haskmc_util::GameMode),
    Difficulty(haskmc_util::Difficulty),
    ...
    Particle(haskmc_data::particle::Particle),
    Msg(String),
    ...
    Bool(bool),
    Simple(String),
    SoundCategory(haskmc_data::sound::SoundCategory),
    DamageType(haskmc_data::damage::DamageType),
    Effect(&'static haskmc_data::effect::StatusEffect),
    Enchantment(&'static haskmc_data::Enchantment),
    EntityAnchor(crate::command::args::EntityAnchor),
    Advancement(&'static haskmc_data::Advancement),
}
