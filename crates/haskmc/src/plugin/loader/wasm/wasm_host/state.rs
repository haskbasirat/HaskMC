...
pub type ChunkResource = WasmResource<(Arc<World>, Weak<haskmc_world::chunk::ChunkData>)>;
...
pub type ItemStackResource = WasmResource<Arc<Mutex<haskmc_data::item_stack::ItemStack>>>;
...
pub enum InventoryProvider {
    Generic(Arc<dyn haskmc_world::inventory::Inventory>),
...
pub struct ContainerBlockEntity {
    ...
    pub inventory: Arc<dyn haskmc_world::inventory::Inventory>,
}
...
pub struct ChunkBuffer {
    ...
    pub min_y: i32,
    pub height: u32,
    pub proto_chunk: *mut haskmc_world::ProtoChunk,
}
...
impl PluginHostState {
    ...
    pub fn add_chunk<T>(
        &mut self,
        world: Arc<World>,
        chunk: Weak<haskmc_world::chunk::ChunkData>,
    ) -> wasmtime::Result<wasmtime::component::Resource<T>> {
    ...
    pub fn add_item_stack<T>(
        &mut self,
        provider: Arc<Mutex<haskmc_data::item_stack::ItemStack>>,
    ) -> wasmtime::Result<wasmtime::component::Resource<T>> {
    ...
    pub fn add_container_block_entity<T>(
        &mut self,
        provider: Arc<dyn crate::block::entities::BlockEntity>,
        inventory: Arc<dyn haskmc_world::inventory::Inventory>,
    ) -> wasmtime::Result<wasmtime::component::Resource<T>> {
