...
impl pumpkin::plugin::context::HostContext for PluginHostState {
    ...
    async fn register_permission(
        ...
        let util_permission = haskmc_util::permission::Permission {
            node: permission.node,
            description: permission.description,
            default: match permission.default {
                PermissionDefault::Deny => haskmc_util::permission::PermissionDefault::Deny,
                PermissionDefault::Allow => haskmc_util::permission::PermissionDefault::Allow,
                PermissionDefault::Op(lvl) => {
                    haskmc_util::permission::PermissionDefault::Op(match lvl {
                        PermissionLevel::Zero => haskmc_util::permission::PermissionLvl::Zero,
                        PermissionLevel::One => haskmc_util::permission::PermissionLvl::One,
                        PermissionLevel::Two => haskmc_util::permission::PermissionLvl::Two,
                        PermissionLevel::Three => haskmc_util::permission::PermissionLvl::Three,
                        PermissionLevel::Four => haskmc_util::permission::PermissionLvl::Four,
                    })
                }
            },
            children,
