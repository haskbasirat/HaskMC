...
use haskmc_data::screen::WindowType;
...
impl gui::HostGui for PluginHostState {
    async fn new(
        ...
        let size = match window_type {
            haskmc_data::screen::WindowType::Generic9x2 => 18,
            haskmc_data::screen::WindowType::Generic9x4 => 36,
            haskmc_data::screen::WindowType::Generic9x5 => 45,
            haskmc_data::screen::WindowType::Generic9x6 => 54,
            haskmc_data::screen::WindowType::Generic3x3 => 9,
            haskmc_data::screen::WindowType::Generic9x1
            | haskmc_data::screen::WindowType::Hopper => 5,
            _ => 27, // Default
        };
