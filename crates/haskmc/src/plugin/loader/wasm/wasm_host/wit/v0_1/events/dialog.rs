use bytes::Bytes;
use haskmc_protocol::java::client::dialog::{
            ...
            let label = match &l.label {
                LinkLabel::BuiltIn(t) => {
                    let link_type = match t {
                        LinkType::BugReport => haskmc_protocol::LinkType::BugReport,
                        LinkType::CommunityGuidelines => {
                            haskmc_protocol::LinkType::CommunityGuidelines
                        }
                        LinkType::Support => haskmc_protocol::LinkType::Support,
                        LinkType::Status => haskmc_protocol::LinkType::Status,
                        LinkType::Feedback => haskmc_protocol::LinkType::Feedback,
                        LinkType::Community => haskmc_protocol::LinkType::Community,
                        LinkType::Website => haskmc_protocol::LinkType::Website,
                        LinkType::Forums => haskmc_protocol::LinkType::Forums,
                        LinkType::News => haskmc_protocol::LinkType::News,
                        LinkType::Announcements => haskmc_protocol::LinkType::Announcements,
                    };
                    haskmc_protocol::Label::BuiltIn(link_type)
                }
                LinkLabel::Custom(c) => haskmc_protocol::Label::TextComponent(Box::new(
...
pub(crate) fn protocol_dialog_to_wasm(
            ...
            ProtocolDialogBody::Item { item: _ } => {
                let item_res = state
                    .add_item_stack(Arc::new(Mutex::new(
                        haskmc_data::item_stack::ItemStack::new(0, &haskmc_data::item::Item::AIR),
                    )))
    ...
    let links = dialog
        ...
        .map(|l| {
            let label = match &l.label {
                haskmc_protocol::Label::BuiltIn(t) => LinkLabel::BuiltIn(match t {
                    haskmc_protocol::LinkType::BugReport => LinkType::BugReport,
                    haskmc_protocol::LinkType::CommunityGuidelines => LinkType::CommunityGuidelines,
                    haskmc_protocol::LinkType::Support => LinkType::Support,
                    haskmc_protocol::LinkType::Status => LinkType::Status,
                    haskmc_protocol::LinkType::Feedback => LinkType::Feedback,
                    haskmc_protocol::LinkType::Community => LinkType::Community,
                    haskmc_protocol::LinkType::Website => LinkType::Website,
                    haskmc_protocol::LinkType::Forums => LinkType::Forums,
                    haskmc_protocol::LinkType::News => LinkType::News,
                    haskmc_protocol::LinkType::Announcements => LinkType::Announcements,
                }),
                haskmc_protocol::Label::TextComponent(c) => {
                    let comp = state
