...
pub const fn to_wit_villager_profession(prof_id: i32) -> WitVillagerProfession {
    let prof = match haskmc_data::villager::VillagerProfession::from_i32(prof_id) {
        Some(p) => p,
        None => haskmc_data::villager::VillagerProfession::None,
    };
    match prof {
        haskmc_data::villager::VillagerProfession::None => WitVillagerProfession::None,
        haskmc_data::villager::VillagerProfession::Armorer => WitVillagerProfession::Armorer,
        haskmc_data::villager::VillagerProfession::Butcher => WitVillagerProfession::Butcher,
        haskmc_data::villager::VillagerProfession::Cartographer => {
            WitVillagerProfession::Cartographer
        }
        haskmc_data::villager::VillagerProfession::Cleric => WitVillagerProfession::Cleric,
        haskmc_data::villager::VillagerProfession::Farmer => WitVillagerProfession::Farmer,
        haskmc_data::villager::VillagerProfession::Fisherman => WitVillagerProfession::Fisherman,
        haskmc_data::villager::VillagerProfession::Fletcher => WitVillagerProfession::Fletcher,
        haskmc_data::villager::VillagerProfession::Leatherworker => {
            WitVillagerProfession::Leatherworker
        }
        haskmc_data::villager::VillagerProfession::Librarian => WitVillagerProfession::Librarian,
        haskmc_data::villager::VillagerProfession::Mason => WitVillagerProfession::Mason,
        haskmc_data::villager::VillagerProfession::Nitwit => WitVillagerProfession::Nitwit,
        haskmc_data::villager::VillagerProfession::Shepherd => WitVillagerProfession::Shepherd,
        haskmc_data::villager::VillagerProfession::Toolsmith => WitVillagerProfession::Toolsmith,
        haskmc_data::villager::VillagerProfession::Weaponsmith => {
...
) -> haskmc_data::villager::VillagerProfession {
    match prof {
        WitVillagerProfession::None => haskmc_data::villager::VillagerProfession::None,
        WitVillagerProfession::Armorer => haskmc_data::villager::VillagerProfession::Armorer,
        WitVillagerProfession::Butcher => haskmc_data::villager::VillagerProfession::Butcher,
        WitVillagerProfession::Cartographer => {
            haskmc_data::villager::VillagerProfession::Cartographer
        }
        WitVillagerProfession::Cleric => haskmc_data::villager::VillagerProfession::Cleric,
        WitVillagerProfession::Farmer => haskmc_data::villager::VillagerProfession::Farmer,
        WitVillagerProfession::Fisherman => haskmc_data::villager::VillagerProfession::Fisherman,
        WitVillagerProfession::Fletcher => haskmc_data::villager::VillagerProfession::Fletcher,
        WitVillagerProfession::Leatherworker => {
            haskmc_data::villager::VillagerProfession::Leatherworker
        }
        WitVillagerProfession::Librarian => haskmc_data::villager::VillagerProfession::Librarian,
        WitVillagerProfession::Mason => haskmc_data::villager::VillagerProfession::Mason,
        WitVillagerProfession::Nitwit => haskmc_data::villager::VillagerProfession::Nitwit,
        WitVillagerProfession::Shepherd => haskmc_data::villager::VillagerProfession::Shepherd,
        WitVillagerProfession::Toolsmith => haskmc_data::villager::VillagerProfession::Toolsmith,
        WitVillagerProfession::Weaponsmith => {
            haskmc_data::villager::VillagerProfession::Weaponsmith
        }
    }
...
#[must_use]
pub const fn to_wit_block_direction(dir: haskmc_data::BlockDirection) -> WitBlockDirection {
    match dir {
        haskmc_data::BlockDirection::Down => WitBlockDirection::Down,
        haskmc_data::BlockDirection::Up => WitBlockDirection::Up,
        haskmc_data::BlockDirection::North => WitBlockDirection::North,
        haskmc_data::BlockDirection::South => WitBlockDirection::South,
        haskmc_data::BlockDirection::West => WitBlockDirection::West,
        haskmc_data::BlockDirection::East => WitBlockDirection::East,
    }
}

#[must_use]
pub const fn from_wit_block_direction(dir: WitBlockDirection) -> haskmc_data::BlockDirection {
    match dir {
        WitBlockDirection::Down => haskmc_data::BlockDirection::Down,
        WitBlockDirection::Up => haskmc_data::BlockDirection::Up,
        WitBlockDirection::North => haskmc_data::BlockDirection::North,
        WitBlockDirection::South => haskmc_data::BlockDirection::South,
        WitBlockDirection::West => haskmc_data::BlockDirection::West,
        WitBlockDirection::East => haskmc_data::BlockDirection::East,
    }
}
            ...
            match goal {
                ...
                crate::plugin::loader::wasm::wasm_host::wit::v0_1::pumpkin::plugin::world::BuiltinAiGoal::LookAtPlayer(range) => {
                    mob_entity.add_goal(priority, crate::entity::ai::goal::look_at_entity::LookAtEntityGoal::new(
                        ...
                        &haskmc_data::entity::EntityType::PLAYER,
                        range,
                        0.02,
                        false,
                    ));
        ...
        if let Some(enderman) = any.downcast_ref::<crate::entity::mob::enderman::EndermanEntity>() {
            return Ok(WitMobData::Enderman(WitEndermanData {
                carried_block_state: enderman
                    .get_carried_block()
                    .map(haskmc_data::BlockStateId::as_u16),
                ...
                {
                    {
                        let mut vdata = villager
                            ...
                            .lock()
                            .unwrap_or_else(std::sync::PoisonError::into_inner);
                        vdata.profession = haskmc_protocol::codec::var_int::VarInt(
                            from_wit_villager_profession(villager_data.profession) as i32,
                        );
                        vdata.level =
                            haskmc_protocol::codec::var_int::VarInt(i32::from(villager_data.level));
                    };
                    villager.xp.store(
            ...
            WitMobData::Enderman(enderman_data) => {
                    ...
                    any.downcast_ref::<crate::entity::mob::enderman::EndermanEntity>()
                {
                    enderman.set_carried_block(
                        enderman_data
                            .carried_block_state
                            .and_then(haskmc_data::BlockStateId::new),
                    );
