use haskmc_protocol::bedrock::client::PackIdVersion;
use std::sync::Arc;
...
use haskmc_protocol::bedrock::client::modal_form_request::CModalFormRequest;
use haskmc_protocol::java::client::dialog::DialogNBT;
use haskmc_util::permission::PermissionLvl;
use haskmc_util::translation::Locale;
use std::str::FromStr;

use haskmc_protocol::bedrock::client::set_actor_data::{
...
use haskmc_util::version::{BedrockMinecraftVersion, JavaMinecraftVersion};
...
pub const fn to_wit_statistic_category(
    category: haskmc_data::statistic::StatisticCategory,
) -> WitStatisticCategory {
    match category {
        haskmc_data::statistic::StatisticCategory::Mined => WitStatisticCategory::Mined,
        haskmc_data::statistic::StatisticCategory::Crafted => WitStatisticCategory::Crafted,
        haskmc_data::statistic::StatisticCategory::Used => WitStatisticCategory::Used,
        haskmc_data::statistic::StatisticCategory::Broken => WitStatisticCategory::Broken,
        haskmc_data::statistic::StatisticCategory::PickedUp => WitStatisticCategory::PickedUp,
        haskmc_data::statistic::StatisticCategory::Dropped => WitStatisticCategory::Dropped,
        haskmc_data::statistic::StatisticCategory::Killed => WitStatisticCategory::Killed,
        haskmc_data::statistic::StatisticCategory::KilledBy => WitStatisticCategory::KilledBy,
        haskmc_data::statistic::StatisticCategory::Custom => WitStatisticCategory::Custom,
    }
}
...
) -> haskmc_data::statistic::StatisticCategory {
    match wit {
        WitStatisticCategory::Mined => haskmc_data::statistic::StatisticCategory::Mined,
        WitStatisticCategory::Crafted => haskmc_data::statistic::StatisticCategory::Crafted,
        WitStatisticCategory::Used => haskmc_data::statistic::StatisticCategory::Used,
        WitStatisticCategory::Broken => haskmc_data::statistic::StatisticCategory::Broken,
        WitStatisticCategory::PickedUp => haskmc_data::statistic::StatisticCategory::PickedUp,
        WitStatisticCategory::Dropped => haskmc_data::statistic::StatisticCategory::Dropped,
        WitStatisticCategory::Killed => haskmc_data::statistic::StatisticCategory::Killed,
        WitStatisticCategory::KilledBy => haskmc_data::statistic::StatisticCategory::KilledBy,
        WitStatisticCategory::Custom => haskmc_data::statistic::StatisticCategory::Custom,
    }
}

#[must_use]
pub const fn to_wit_custom_statistic(
    stat: haskmc_data::statistic::CustomStatistic,
) -> WitCustomStatistic {
...
) -> haskmc_data::statistic::CustomStatistic {
    haskmc_data::statistic::CustomStatistic::from_i32(wit as i32)
        .unwrap_or(haskmc_data::statistic::CustomStatistic::PlayTime)
}
...
) -> haskmc_protocol::bedrock::client::update_abilities::Ability {
    match ability {
        pumpkin::plugin::player::BedrockAbility::Build => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::Build
        }
        pumpkin::plugin::player::BedrockAbility::Mine => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::Mine
        }
        pumpkin::plugin::player::BedrockAbility::DoorsAndSwitches => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::DoorsAndSwitches
        }
        pumpkin::plugin::player::BedrockAbility::OpenContainers => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::OpenContainers
        }
        pumpkin::plugin::player::BedrockAbility::AttackPlayers => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::AttackPlayers
        }
        pumpkin::plugin::player::BedrockAbility::AttackMobs => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::AttackMobs
        }
        pumpkin::plugin::player::BedrockAbility::OperatorCommands => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::OperatorCommands
        }
        pumpkin::plugin::player::BedrockAbility::Teleport => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::Teleport
        }
        pumpkin::plugin::player::BedrockAbility::Invulnerable => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::Invulnerable
        }
        pumpkin::plugin::player::BedrockAbility::Flying => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::Flying
        }
        pumpkin::plugin::player::BedrockAbility::MayFly => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::MayFly
        }
        pumpkin::plugin::player::BedrockAbility::Instabuild => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::Instabuild
        }
        pumpkin::plugin::player::BedrockAbility::Lightning => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::Lightning
        }
        pumpkin::plugin::player::BedrockAbility::FlySpeed => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::FlySpeed
        }
        pumpkin::plugin::player::BedrockAbility::WalkSpeed => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::WalkSpeed
        }
        pumpkin::plugin::player::BedrockAbility::Muted => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::Muted
        }
        pumpkin::plugin::player::BedrockAbility::WorldBuilder => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::WorldBuilder
        }
        pumpkin::plugin::player::BedrockAbility::NoClip => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::NoClip
        }
        pumpkin::plugin::player::BedrockAbility::PrivilegedBuilder => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::PrivilegedBuilder
        }
        pumpkin::plugin::player::BedrockAbility::VerticalFlySpeed => {
            haskmc_protocol::bedrock::client::update_abilities::Ability::VerticalFlySpeed
        }
    }
}
...
const fn from_wasm_bedrock_status_flag(flag: pumpkin::plugin::player::BedrockStatusFlag) -> u32 {
    use haskmc_protocol::bedrock::client::set_actor_data::entity_data_flag;
    match flag {
...
) -> haskmc_util::text::TextComponent {
    state
        .resource_table
...
use haskmc_inventory::generic_container_screen_handler::GenericContainerScreenHandler;
...
use haskmc_protocol::java::client::play::CSetContainerSlot;
use haskmc_world::inventory::{Clearable, Inventory};
...
impl pumpkin::plugin::player::HostPlayer for PluginHostState {
    async fn set_item_in_hand(
        ...
        let stack = if let Some(stack_res) = stack {
            ...
            haskmc_data::item_stack::ItemStack::EMPTY.clone()
        };

        let hand = from_wasm_hand(hand);
        let slot = match hand {
            haskmc_util::Hand::Right => player.inventory().get_selected_slot() as usize,
            haskmc_util::Hand::Left => PlayerInventory::OFF_HAND_SLOT,
        };
    ...
    async fn clear_ender_chest(&mut self, player: Resource<Player>) -> wasmtime::Result<()> {
        ...
        if let Some(sync_id) = sync_id {
            let empty_serializer =
                ItemStackSerializer::from(haskmc_data::item_stack::ItemStack::EMPTY.clone());
            for slot in 0..27 {
                let packet =
    ...
    async fn add_effect(
        ...
        if let Some(status_effect) =
            haskmc_data::effect::StatusEffect::from_name(effect_type.to_name())
        {
            let effect_obj = haskmc_data::potion::Effect {
    ...
    async fn set_compass_target(
        ...
        let block_pos = haskmc_util::math::position::BlockPos::new(
            pos_vec.x as i32,
            pos_vec.y as i32,
            pos_vec.z as i32,
        );
    ...
    > {
        ...
        let target = player
            .get_compass_target()
            .unwrap_or(haskmc_util::math::position::BlockPos::new(0, 0, 0));
        let vec3 = haskmc_util::math::vector3::Vector3::new(
            f64::from(target.0.x),
            f64::from(target.0.y),
            f64::from(target.0.z),
        );
    ...
    async fn open_gui(
        ...
        let screen_handler: Arc<
            std::sync::Mutex<dyn haskmc_inventory::screen_handler::ScreenHandler>,
    ...
    async fn transfer(
        ...
        if let crate::net::ClientPlatform::Java(client) = player.client.as_ref() {
            client
                .send_packet(&haskmc_protocol::java::client::play::CTransfer::new(
                    &host,
                    haskmc_protocol::codec::var_int::VarInt(i32::from(port)),
                ))
                .await;
        }
        Ok(())
...
impl pumpkin::plugin::player::HostJavaPlayer for PluginHostState {
    ...
    async fn get_settings(
        ...
        Ok(pumpkin::plugin::player::JavaPlayerSettings {
            ...
            main_hand: match config.main_hand {
                haskmc_util::Hand::Left => pumpkin::plugin::common::Hand::Left,
                haskmc_util::Hand::Right => pumpkin::plugin::common::Hand::Right,
            },
    ...
    async fn send_custom_payload(
        ...
        if let crate::net::ClientPlatform::Java(_) = player.client.as_ref() {
            player
                .send_client_packet(&haskmc_protocol::java::client::play::CCustomPayload::new(
                    &channel, &data,
                ))
                .await;
        }
    ...
    async fn show_dialog(
        ...
        if let crate::net::ClientPlatform::Java(client) = player.client.as_ref() {
            match client.connection_state.load() {
                haskmc_protocol::ConnectionState::Config => {
                    client
                        .send_packet(
                            &haskmc_protocol::java::client::config::CConfigShowDialog::new(
                                haskmc_protocol::IdOr::Value(DialogNBT::from_dialog(
                                    &protocol_dialog,
                                )),
                            ),
                        )
                ...
                haskmc_protocol::ConnectionState::Play => {
                    client
                        .send_packet(&haskmc_protocol::java::client::play::CPlayShowDialog::new(
                            haskmc_protocol::IdOr::Value(DialogNBT::from_dialog(&protocol_dialog)),
                        ))
                        .await;
                }
                _ => {}
        ...
        if let crate::net::ClientPlatform::Java(client) = player.client.as_ref() {
            match client.connection_state.load() {
                haskmc_protocol::ConnectionState::Config => {
                    client
                        .send_packet(
                            &haskmc_protocol::java::client::config::CConfigClearDialog::new(),
                        )
                        .await;
                }
                haskmc_protocol::ConnectionState::Play => {
                    client
                        .send_packet(&haskmc_protocol::java::client::play::CPlayClearDialog::new())
                        .await;
                }
                _ => {}
            }
    ...
    async fn send_resource_pack(
        ...
        if let crate::net::ClientPlatform::Java(client) = player.client.as_ref() {
            client
                .send_packet(&haskmc_protocol::java::client::play::CAddResourcePack::new(
                    &uuid,
                    &pack.url,
                    &pack.hash,
                    pack.forced,
    ...
    async fn remove_resource_pack(
        ...
        if let crate::net::ClientPlatform::Java(client) = player.client.as_ref() {
            client
                .send_packet(
                    &haskmc_protocol::java::client::play::CRemoveResourcePack::new(Some(&uuid)),
                )
                .await;
        }
        Ok(())
    ...
    async fn clear_resource_packs(
        ...
        if let crate::net::ClientPlatform::Java(client) = player.client.as_ref() {
            client
                .send_packet(&haskmc_protocol::java::client::play::CRemoveResourcePack::new(None))
                .await;
        }
        Ok(())
    }
        ...
        if let crate::net::ClientPlatform::Bedrock(client) = player.client.as_ref() {
            ...
            client
                .send_packet(&CModalFormRequest {
                    form_id: haskmc_protocol::codec::var_uint::VarUInt(form_id),
    ...
    async fn send_resource_packs_info(
        ...
        if let crate::net::ClientPlatform::Bedrock(client) = player.client.as_ref() {
            let entries = info
                ...
                .into_iter()
                .map(
                    |p| haskmc_protocol::bedrock::client::resource_packs_info::PackInfoData {
            ...
            let packs_info =
                haskmc_protocol::bedrock::client::resource_packs_info::CResourcePacksInfo {
