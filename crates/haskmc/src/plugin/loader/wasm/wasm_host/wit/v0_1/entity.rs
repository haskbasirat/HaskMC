...
use haskmc_data::entity::EntityPose as InternalEntityPose;
...
impl HostEntity for PluginHostState {
    ...
    async fn set_velocity(
        ...
        entity
            .get_entity()
            .velocity
            .store(haskmc_util::math::vector3::Vector3::new(
    ...
    async fn get_nearby_entities(
        ...
        let box_range = haskmc_util::math::boundingbox::BoundingBox::new(
