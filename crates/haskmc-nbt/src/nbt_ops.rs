//! NBT support for `HaskMC`'s dynamic serialization operations.

use crate::compound::NbtCompound;
use crate::tag::NbtTag;
use haskmc_codecs::DataResult;
use haskmc_codecs::DynamicOps;
use haskmc_codecs::Lifecycle;
use haskmc_codecs::MapLike;
use haskmc_codecs::Number;
use haskmc_codecs::struct_builder::{ResultStructBuilder, StringStructBuilder, StructBuilder};
use haskmc_codecs::{impl_get_list, impl_string_struct_builder, impl_struct_builder};
use std::iter::Map;
