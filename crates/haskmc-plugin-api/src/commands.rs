...
///
/// ```rust,ignore
/// use haskmc_plugin_api::command::{CommandSuggestion, CommandSuggestions, SuggestionRequest};
/// use haskmc_plugin_api::commands::CommandSuggestionHandler;
/// use haskmc_plugin_api::Server;
///
...
///     fn suggest(
///         &self,
///         _sender: haskmc_plugin_api::command::CommandSender,
///         _server: Server,
