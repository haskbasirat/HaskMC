...
use haskmc_nbt::{compound::NbtCompound, nbt_compress::read_gzip_compound_tag, tag::NbtTag};
...
pub fn write_weather(level_folder: &Path, data: &WeatherData) -> Result<(), WorldInfoError> {
    ...
    haskmc_nbt::nbt_compress::write_gzip_compound_tag(root, BufWriter::new(file))
...
pub fn write_game_rules(
    ...
    haskmc_nbt::nbt_compress::write_gzip_compound_tag(compound, file)
        .map_err(|e| WorldInfoError::SerializationError(e.to_string()))
}
...
pub fn write_world_clocks(
    ...
    haskmc_nbt::nbt_compress::write_gzip_compound_tag(root, file)
        .map_err(|e| WorldInfoError::SerializationError(e.to_string()))
}
