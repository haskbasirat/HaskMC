...
use haskmc_util::{Difficulty, world_seed::Seed};
...
mod test {
    ...
    use haskmc_data::game_rules::GameRuleRegistry;
    use haskmc_nbt::{
        compound::NbtCompound,
        nbt_compress::{read_gzip_compound_tag, write_gzip_compound_tag},
        tag::NbtTag,
    ...
    fn serialize_level_dat() {
        let mut data_comp = haskmc_nbt::compound::NbtCompound::new();
        ...
        let bytes = haskmc_nbt::Nbt::from(root).write();
