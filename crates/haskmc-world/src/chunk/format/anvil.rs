...
use haskmc_config::chunk::AnvilChunkConfig;
...
pub const SUBREGION_BITS: u8 = haskmc_util::math::ceil_log2(REGION_SIZE as u32);
...
impl From<haskmc_config::chunk::Compression> for Compression {
    fn from(value: haskmc_config::chunk::Compression) -> Self {
        // :c
        match value {
            haskmc_config::chunk::Compression::GZip => Self::GZip,
            haskmc_config::chunk::Compression::ZLib => Self::ZLib,
            haskmc_config::chunk::Compression::LZ4 => Self::LZ4,
            haskmc_config::chunk::Compression::Custom => Self::Custom,
        }
    }
}
...
mod tests {
    ...
    use haskmc_config::{AdvancedConfiguration, advanced_config, override_config_for_testing};
