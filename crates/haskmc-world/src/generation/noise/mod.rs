...
use haskmc_data::{Block, BlockState, chunk_gen_settings::GenerationShapeConfig};
use haskmc_util::{math::vector3::Vector3, random::xoroshiro128::XoroshiroSplitter};
...
impl<'a> ChunkNoiseGenerator<'a> {
    ...
    pub fn new(
        ...
        >,
        affected_box: Option<haskmc_util::math::block_box::BlockBox>,
    ) -> Self {
