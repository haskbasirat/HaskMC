...
use haskmc_util::{noise::perlin::OctavePerlinNoiseSampler, random::RandomImpl};
...
mod octave_perline_noise_sampler_test {
    use haskmc_util::random::{RandomGenerator, RandomImpl, xoroshiro128::Xoroshiro};
...
mod perlin_noise_sampler_test {
    ...
    use haskmc_util::noise::perlin::OctavePerlinNoiseSampler;
