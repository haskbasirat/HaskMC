...
use haskmc_util::{BlockDirection, math::block_box::BlockBox, random::RandomGenerator};
...
impl StructurePieceBase for CorridorNetherWartsRoomPiece {
    ...
    fn place(
        ...
        let fence = |west: bool, east: bool, north: bool, south: bool| {
            ...
            props.north = north;
            props.south = south;
            haskmc_data::BlockState::from_id(props.to_state_id(&Block::NETHER_BRICK_FENCE))
        };
        ...
        let stair_n =
            haskmc_data::BlockState::from_id(stair_props.to_state_id(&Block::NETHER_BRICK_STAIRS));
