use haskmc_data::{Mirror, Rotation};
...
impl PoolAliasLookup {
    ...
    pub fn from_bindings(
        bindings: &[haskmc_data::structures::PoolAliasBinding],
    ...
    fn add_binding(
        &mut self,
        binding: &haskmc_data::structures::PoolAliasBinding,
        random: &mut RandomGenerator,
    ) {
        use haskmc_data::structures::PoolAliasBinding;
        match binding {
...
pub const fn rotate_direction(
    dir: haskmc_util::BlockDirection,
    rotation: Rotation,
) -> haskmc_util::BlockDirection {
    use haskmc_util::BlockDirection;
    match rotation {
        Rotation::None => dir,
