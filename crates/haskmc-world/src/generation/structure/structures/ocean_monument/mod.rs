...
use haskmc_data::{Block, BlockState};
...
pub(crate) fn has_valid_biomes(
    ...
    let start_biomes = haskmc_data::tag::WorldgenBiome::MINECRAFT_HAS_STRUCTURE_OCEAN_MONUMENT.1;
    ...
    let allowed = haskmc_data::tag::WorldgenBiome::MINECRAFT_REQUIRED_OCEAN_MONUMENT_SURROUNDING.1;
...
mod tests {
    ...
    fn elder_guardian_nbt_is_accepted_by_the_entity_loader() {
        let nbt = elder_guardian_nbt(haskmc_util::math::vector3::Vector3::new(1, 2, 3));
