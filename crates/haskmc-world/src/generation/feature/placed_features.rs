...
use haskmc_data::{Block, BlockDirection, BlockStateId};
use haskmc_util::HeightMap;
use std::collections::HashMap;
use std::iter;
use std::sync::LazyLock;

use haskmc_util::biome::FOLIAGE_NOISE;
use haskmc_util::math::int_provider::IntProvider;
...
pub static PLACED_FEATURES: LazyLock<
    HashMap<haskmc_data::placed_feature::PlacedFeature, PlacedFeature>,
> = LazyLock::new(build_placed_features);

pub enum PlacedFeatureWrapper {
    Direct(PlacedFeature),
    Named(haskmc_data::placed_feature::PlacedFeature),
}
...
pub enum Feature {
    Named(haskmc_data::configured_feature::ConfiguredFeature),
...
impl PlacedFeature {
    pub fn generate_in_proto_chunk(
        ...
        feature_name: haskmc_data::placed_feature::PlacedFeature,
    ...
    pub fn generate<T: GenerationCache>(
        ...
        min_y: i8,
        height: u16,
        feature_name: haskmc_data::placed_feature::PlacedFeature, // This placed feature
        random: &mut RandomGenerator,
        pos: BlockPos,
    ) -> bool {
...
impl ConditionalPlacementModifier for BlockFilterPlacementModifier {
    fn should_place<T: GenerationCache>(
        &self,
        block_registry: &dyn WorldPortalExt,
        _feature: haskmc_data::placed_feature::PlacedFeature,
        chunk: &T,
...
impl ConditionalPlacementModifier for BiomePlacementModifier {
    fn should_place<T: GenerationCache>(
        &self,
        _block_registry: &dyn WorldPortalExt,
        this_feature: haskmc_data::placed_feature::PlacedFeature,
        chunk: &T,
        _random: &mut RandomGenerator,
        pos: BlockPos,
    ) -> bool {
...
pub const fn all_placed_feature_names() -> &'static [&'static str] {
    haskmc_data::placed_feature::PlacedFeature::all_names()
}
include!("../../../../haskmc-data/src/generated/placed_features_generated.rs");
