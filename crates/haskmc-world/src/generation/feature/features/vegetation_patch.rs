...
pub struct VegetationPatchFeature {
    ...
    pub depth: haskmc_util::math::int_provider::IntProvider,
    pub extra_bottom_block_chance: f32,
    pub vertical_range: i32,
    pub vegetation_chance: f32,
    pub xz_radius: haskmc_util::math::int_provider::IntProvider,
...
impl VegetationPatchFeature {
    ...
    pub(crate) const fn surface_direction(&self) -> haskmc_data::BlockDirection {
        match self.surface {
            VerticalSurfaceType::Floor => haskmc_data::BlockDirection::Down,
            VerticalSurfaceType::Ceiling => haskmc_data::BlockDirection::Up,
        }
    }
    ...
    fn place_ground<T: GenerationCache>(
        ...
        for i in 0..depth {
            ...
            let state_block_id = haskmc_data::Block::from_state_id(state_to_place.id).id;
