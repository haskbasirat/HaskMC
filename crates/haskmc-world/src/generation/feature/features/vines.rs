use haskmc_data::{Block, BlockDirection, BlockState, block_properties::BlockProperties};
...
impl VinesFeature {
    pub fn generate<T: GenerationCache>(
        ...
        for dir in BlockDirection::all() {
            ...
            let mut vine = haskmc_data::block_properties::VineLikeProperties::default(&Block::VINE);
