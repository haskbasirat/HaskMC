...
use haskmc_data::{Block, BlockDirection, BlockId, BlockState, BlockStateId};
use haskmc_util::{
...
impl GeodeFeature {
    ...
    pub fn generate<T: GenerationCache>(
        ...
        _min_y: i8,
        _height: u16,
        _feature_name: haskmc_data::placed_feature::PlacedFeature,
                ...
                for dir in &BlockDirection::all() {
                    ...
                    if is_air || is_water {
                        ...
                        let dir_name = match dir {
                            haskmc_data::BlockDirection::Up => "up",
                            haskmc_data::BlockDirection::Down => "down",
                            haskmc_data::BlockDirection::North => "north",
                            haskmc_data::BlockDirection::South => "south",
                            haskmc_data::BlockDirection::East => "east",
                            haskmc_data::BlockDirection::West => "west",
                        };
